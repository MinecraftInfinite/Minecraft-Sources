   ...
   private Map<ResourceLocation, Advancement.Builder> loadCustomAdvancements(IResourceManager p_195439_1_) {
      ...
      for(ResourceLocation resourcelocation : p_195439_1_.getAllResourceLocations("advancements", (p_195440_0_) -> {
         ...
         try (IResource iresource = p_195439_1_.getResource(resourcelocation)) {
            Advancement.Builder advancement$builder = (Advancement.Builder)JsonUtils.fromJson(GSON, IOUtils.toString(iresource.getInputStream(), StandardCharsets.UTF_8), Advancement.Builder.class);
