...
public class FunctionManager implements ITickable, IResourceManagerReloadListener {
   ...
   private final TagCollection<FunctionObject> tagCollection = new TagCollection<FunctionObject>((p_200107_1_) -> {
      return this.getFunction(p_200107_1_) != null;
   }, this::getFunction, "tags/functions", true, "function");
   private final List<FunctionObject> tickFunctions = Lists.<FunctionObject>newArrayList();
   ...
   public void onResourceManagerReload(IResourceManager resourceManager) {
      ...
      List<CompletableFuture<FunctionObject>> list = Lists.<CompletableFuture<FunctionObject>>newArrayList();
