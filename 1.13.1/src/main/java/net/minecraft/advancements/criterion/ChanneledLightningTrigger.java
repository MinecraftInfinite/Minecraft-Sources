...
public class ChanneledLightningTrigger implements ICriterionTrigger<ChanneledLightningTrigger.Instance> {
   ...
   private final Map<PlayerAdvancements, ChanneledLightningTrigger.Listeners> listeners = Maps.<PlayerAdvancements, ChanneledLightningTrigger.Listeners>newHashMap();
   ...
   static class Listeners {
      ...
      private final Set<ICriterionTrigger.Listener<ChanneledLightningTrigger.Instance>> listeners = Sets.<ICriterionTrigger.Listener<ChanneledLightningTrigger.Instance>>newHashSet();
      ...
      public void trigger(EntityPlayerMP p_204846_1_, Collection<? extends Entity> p_204846_2_) {
         ...
         for(ICriterionTrigger.Listener<ChanneledLightningTrigger.Instance> listener : this.listeners) {
            if (((ChanneledLightningTrigger.Instance)listener.getCriterionInstance()).func_204823_a(p_204846_1_, p_204846_2_)) {
               if (list == null) {
                  list = Lists.<ICriterionTrigger.Listener<ChanneledLightningTrigger.Instance>>newArrayList();
               }
