...
public class ConsumeItemTrigger implements ICriterionTrigger<ConsumeItemTrigger.Instance> {
   ...
   public static class Instance extends AbstractCriterionInstance {
      ...
      public static ConsumeItemTrigger.Instance func_203913_a(IItemProvider p_203913_0_) {
         return new ConsumeItemTrigger.Instance(new ItemPredicate((Tag)null, p_203913_0_.asItem(), MinMaxBounds.IntBound.UNBOUNDED, MinMaxBounds.IntBound.UNBOUNDED, new EnchantmentPredicate[0], (PotionType)null, NBTPredicate.ANY));
      }
