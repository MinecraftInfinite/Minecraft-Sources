...
public class EntityTypePredicate {
   ...
   public static EntityTypePredicate deserialize(@Nullable JsonElement p_209370_0_) {
      if (p_209370_0_ != null && !p_209370_0_.isJsonNull()) {
         ...
         EntityType<?> entitytype = IRegistry.ENTITY_TYPE.get(resourcelocation);
         if (entitytype == null) {
   ...
   public JsonElement serialize() {
      return (JsonElement)(this.type == null ? JsonNull.INSTANCE : new JsonPrimitive(IRegistry.ENTITY_TYPE.getKey(this.type).toString()));
   }
}
