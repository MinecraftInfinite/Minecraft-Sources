   ...
   static class Listeners {
      ...
      public void func_204854_a(ItemStack p_204854_1_) {
         ...
         for(ICriterionTrigger.Listener<FilledBucketTrigger.Instance> listener : this.field_204857_b) {
            if (((FilledBucketTrigger.Instance)listener.getCriterionInstance()).func_204826_a(p_204854_1_)) {
               if (list == null) {
                  list = Lists.<ICriterionTrigger.Listener<FilledBucketTrigger.Instance>>newArrayList();
               }
