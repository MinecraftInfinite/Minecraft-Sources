...
public class FishingRodHookedTrigger implements ICriterionTrigger<FishingRodHookedTrigger.Instance> {
   ...
   private final Map<PlayerAdvancements, FishingRodHookedTrigger.Listeners> listeners = Maps.<PlayerAdvancements, FishingRodHookedTrigger.Listeners>newHashMap();
   ...
   static class Listeners {
      ...
      private final Set<ICriterionTrigger.Listener<FishingRodHookedTrigger.Instance>> listeners = Sets.<ICriterionTrigger.Listener<FishingRodHookedTrigger.Instance>>newHashSet();
      ...
      public void trigger(EntityPlayerMP p_204859_1_, ItemStack p_204859_2_, EntityFishHook p_204859_3_, Collection<ItemStack> p_204859_4_) {
         ...
         for(ICriterionTrigger.Listener<FishingRodHookedTrigger.Instance> listener : this.listeners) {
            if (((FishingRodHookedTrigger.Instance)listener.getCriterionInstance()).func_204830_a(p_204859_1_, p_204859_2_, p_204859_3_, p_204859_4_)) {
               if (list == null) {
                  list = Lists.<ICriterionTrigger.Listener<FishingRodHookedTrigger.Instance>>newArrayList();
               }
