   ...
   public static class Instance extends AbstractCriterionInstance {
      ...
      public static InventoryChangeTrigger.Instance func_203922_a(IItemProvider... p_203922_0_) {
         ...
         for(int i = 0; i < p_203922_0_.length; ++i) {
            aitempredicate[i] = new ItemPredicate((Tag)null, p_203922_0_[i].asItem(), MinMaxBounds.IntBound.UNBOUNDED, MinMaxBounds.IntBound.UNBOUNDED, new EnchantmentPredicate[0], (PotionType)null, NBTPredicate.ANY);
         }
