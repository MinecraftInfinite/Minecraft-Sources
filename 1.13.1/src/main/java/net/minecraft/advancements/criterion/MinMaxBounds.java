...
public abstract class MinMaxBounds<T extends Number> {
   public static final SimpleCommandExceptionType ERROR_EMPTY = new SimpleCommandExceptionType(new TextComponentTranslation("argument.range.empty", new Object[0]));
   public static final SimpleCommandExceptionType ERROR_SWAPPED = new SimpleCommandExceptionType(new TextComponentTranslation("argument.range.swapped", new Object[0]));
   ...
   private static <T extends Number> T readNumber(StringReader p_196975_0_, Function<String, T> p_196975_1_, Supplier<DynamicCommandExceptionType> p_196975_2_) throws CommandSyntaxException {
      ...
      if (s.isEmpty()) {
         ...
         try {
            ...
            throw ((DynamicCommandExceptionType)p_196975_2_.get()).createWithContext(p_196975_0_, s);
         }
      }
   }
