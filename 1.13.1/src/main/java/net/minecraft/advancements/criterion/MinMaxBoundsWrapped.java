...
public class MinMaxBoundsWrapped {
   ...
   public static final SimpleCommandExceptionType ERROR_INTS_ONLY = new SimpleCommandExceptionType(new TextComponentTranslation("argument.range.ints", new Object[0]));
