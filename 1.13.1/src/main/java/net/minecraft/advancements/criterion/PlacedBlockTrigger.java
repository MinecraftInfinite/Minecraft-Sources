...
public class PlacedBlockTrigger implements ICriterionTrigger<PlacedBlockTrigger.Instance> {
   ...
   public static class Instance extends AbstractCriterionInstance {
      ...
      public static PlacedBlockTrigger.Instance placedBlock(Block p_203934_0_) {
         return new PlacedBlockTrigger.Instance(p_203934_0_, (Map)null, LocationPredicate.ANY, ItemPredicate.ANY);
      }
      ...
      public JsonElement serialize() {
         ...
         if (this.properties != null) {
            ...
            for(Entry<IProperty<?>, Object> entry : this.properties.entrySet()) {
               jsonobject1.addProperty(((IProperty)entry.getKey()).getName(), Util.getValueName(entry.getKey(), entry.getValue()));
            }
