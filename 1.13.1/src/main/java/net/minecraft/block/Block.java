...
public class Block implements IItemProvider {
   ...
   private static final ThreadLocal<Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey>> SHOULD_SIDE_RENDER_CACHE = ThreadLocal.<Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey>>withInitial(() -> {
   ...
   public static class Properties {
      ...
      protected Block.Properties needsRandomTick() {
