...
public class BlockAnvil extends BlockFalling {
   ...
   public IBlockState getStateForPlacement(BlockItemUseContext context) {
      return (IBlockState)this.getDefaultState().with(FACING, context.getPlacementHorizontalFacing().rotateY());
   }
   ...
   public static IBlockState damage(IBlockState p_196433_0_) {
      ...
      if (block == Blocks.ANVIL) {
         return (IBlockState)Blocks.CHIPPED_ANVIL.getDefaultState().with(FACING, p_196433_0_.get(FACING));
      } else {
         return block == Blocks.CHIPPED_ANVIL ? (IBlockState)Blocks.DAMAGED_ANVIL.getDefaultState().with(FACING, p_196433_0_.get(FACING)) : null;
      }
   }
   ...
   public static class Anvil implements IInteractionObject {
      ...
      public ITextComponent getName() {
         return new TextComponentTranslation(Blocks.ANVIL.getTranslationKey(), new Object[0]);
      }
