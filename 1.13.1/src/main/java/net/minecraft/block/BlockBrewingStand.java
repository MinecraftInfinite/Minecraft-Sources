...
public class BlockBrewingStand extends BlockContainer {
   ...
   public BlockBrewingStand(Block.Properties properties) {
      super(properties);
      this.setDefaultState((IBlockState)((IBlockState)((IBlockState)(this.stateContainer.getBaseState()).with(HAS_BOTTLE[0], Boolean.valueOf(false))).with(HAS_BOTTLE[1], Boolean.valueOf(false))).with(HAS_BOTTLE[2], Boolean.valueOf(false)));
   }
