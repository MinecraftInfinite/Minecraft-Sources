...
public class BlockBubbleColumn extends Block implements IBucketPickupHandler {
   ...
   public BlockBubbleColumn(Block.Properties properties) {
      super(properties);
      this.setDefaultState((IBlockState)(this.stateContainer.getBaseState()).with(DRAG, Boolean.valueOf(true)));
   }
   ...
   public static void placeBubbleColumn(IWorld p_203159_0_, BlockPos p_203159_1_, boolean drag) {
      if (canHoldBubbleColumn(p_203159_0_, p_203159_1_)) {
         p_203159_0_.setBlockState(p_203159_1_, (IBlockState)Blocks.BUBBLE_COLUMN.getDefaultState().with(DRAG, Boolean.valueOf(drag)), 2);
      }
   ...
   public IBlockState updatePostPlacement(IBlockState stateIn, EnumFacing facing, IBlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      if (!stateIn.isValidPosition(worldIn, currentPos)) {
         ...
         if (facing == EnumFacing.DOWN) {
            worldIn.setBlockState(currentPos, (IBlockState)Blocks.BUBBLE_COLUMN.getDefaultState().with(DRAG, Boolean.valueOf(getDrag(worldIn, facingPos))), 2);
