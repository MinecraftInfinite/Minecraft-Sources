...
public class BlockChorusFlower extends Block {
   ...
   private void placeGrownFlower(World worldIn, BlockPos pos, int age) {
      worldIn.setBlockState(pos, (IBlockState)this.getDefaultState().with(AGE, Integer.valueOf(age)), 2);
      worldIn.playEvent(1033, pos, 0);
   }

   private void placeDeadFlower(World worldIn, BlockPos pos) {
      worldIn.setBlockState(pos, (IBlockState)this.getDefaultState().with(AGE, Integer.valueOf(5)), 2);
   ...
   private static void growTreeRecursive(IWorld worldIn, BlockPos p_185601_1_, Random rand, BlockPos p_185601_3_, int p_185601_4_, int p_185601_5_) {
      ...
      if (!flag) {
         worldIn.setBlockState(p_185601_1_.up(i), (IBlockState)Blocks.CHORUS_FLOWER.getDefaultState().with(AGE, Integer.valueOf(5)), 2);
      }
