...
public class BlockCrops extends BlockBush implements IGrowable {
   ...
   protected BlockCrops(Block.Properties builder) {
      super(builder);
      this.setDefaultState((IBlockState)(this.stateContainer.getBaseState()).with(this.getAgeProperty(), Integer.valueOf(0)));
   }
   ...
   public IBlockState withAge(int age) {
      return (IBlockState)this.getDefaultState().with(this.getAgeProperty(), Integer.valueOf(age));
   }
