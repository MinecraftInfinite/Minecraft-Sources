...
public class BlockFourWay extends Block implements IBucketPickupHandler, ILiquidContainer {
   ...
   protected static final Map<EnumFacing, BooleanProperty> FACING_TO_PROPERTY_MAP = (Map)BlockSixWay.FACING_TO_PROPERTY_MAP.entrySet().stream().filter((p_199775_0_) -> {
      return ((EnumFacing)p_199775_0_.getKey()).getAxis().isHorizontal();
