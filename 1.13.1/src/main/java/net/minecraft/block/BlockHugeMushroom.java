...
public class BlockHugeMushroom extends Block {
   ...
   public BlockHugeMushroom(@Nullable Block p_i48376_1_, Block.Properties p_i48376_2_) {
      ...
      this.setDefaultState((IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)(this.stateContainer.getBaseState()).with(NORTH, Boolean.valueOf(true))).with(EAST, Boolean.valueOf(true))).with(SOUTH, Boolean.valueOf(true))).with(WEST, Boolean.valueOf(true))).with(UP, Boolean.valueOf(true))).with(DOWN, Boolean.valueOf(true)));
   }
