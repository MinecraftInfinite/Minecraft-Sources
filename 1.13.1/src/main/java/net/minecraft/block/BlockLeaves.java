...
public class BlockLeaves extends Block {
   ...
   public BlockLeaves(Block.Properties properties) {
      super(properties);
      this.setDefaultState((IBlockState)((IBlockState)(this.stateContainer.getBaseState()).with(DISTANCE, Integer.valueOf(7))).with(PERSISTENT, Boolean.valueOf(false)));
   }
   ...
   private static IBlockState updateDistance(IBlockState p_208493_0_, IWorld p_208493_1_, BlockPos p_208493_2_) {
      ...
      return (IBlockState)p_208493_0_.with(DISTANCE, Integer.valueOf(i));
   }
   ...
   public IBlockState getStateForPlacement(BlockItemUseContext context) {
      return updateDistance((IBlockState)this.getDefaultState().with(PERSISTENT, Boolean.valueOf(true)), context.getWorld(), context.getPos());
   }
}
