...
public class BlockPortal extends Block {
   ...
   public BlockPortal(Block.Properties properties) {
      super(properties);
      this.setDefaultState((IBlockState)(this.stateContainer.getBaseState()).with(AXIS, EnumFacing.Axis.X));
   }
   ...
   public IBlockState updatePostPlacement(IBlockState stateIn, EnumFacing facing, IBlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      ...
      EnumFacing.Axis enumfacing$axis1 = (EnumFacing.Axis)stateIn.get(AXIS);
      ...
      public void placePortalBlocks() {
         for(int i = 0; i < this.width; ++i) {
            ...
            for(int j = 0; j < this.height; ++j) {
               this.world.setBlockState(blockpos.up(j), (IBlockState)Blocks.NETHER_PORTAL.getDefaultState().with(BlockPortal.AXIS, this.axis), 18);
            }
         }
