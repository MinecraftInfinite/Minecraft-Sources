...
public class BlockPressurePlate extends BlockBasePressurePlate {
   ...
   protected BlockPressurePlate(BlockPressurePlate.Sensitivity p_i48348_1_, Block.Properties p_i48348_2_) {
      super(p_i48348_2_);
      this.setDefaultState((IBlockState)(this.stateContainer.getBaseState()).with(POWERED, Boolean.valueOf(false)));
   ...
   protected IBlockState setRedstoneStrength(IBlockState state, int strength) {
      return (IBlockState)state.with(POWERED, Boolean.valueOf(strength > 0));
   }
