...
public class BlockPressurePlateWeighted extends BlockBasePressurePlate {
   ...
   protected BlockPressurePlateWeighted(int p_i48295_1_, Block.Properties p_i48295_2_) {
      super(p_i48295_2_);
      this.setDefaultState((IBlockState)(this.stateContainer.getBaseState()).with(POWER, Integer.valueOf(0)));
   ...
   protected IBlockState setRedstoneStrength(IBlockState state, int strength) {
      return (IBlockState)state.with(POWER, Integer.valueOf(strength));
   }
