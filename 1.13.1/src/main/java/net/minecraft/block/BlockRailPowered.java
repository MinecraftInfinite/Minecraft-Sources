...
public class BlockRailPowered extends BlockRailBase {
   ...
   protected BlockRailPowered(Block.Properties builder) {
      super(true, builder);
      this.setDefaultState((IBlockState)((IBlockState)(this.stateContainer.getBaseState()).with(SHAPE, RailShape.NORTH_SOUTH)).with(POWERED, Boolean.valueOf(false)));
   }
   ...
   protected boolean func_208071_a(World p_208071_1_, BlockPos p_208071_2_, boolean p_208071_3_, int p_208071_4_, RailShape p_208071_5_) {
      ...
      if (iblockstate.getBlock() != this) {
         ...
         RailShape railshape = (RailShape)iblockstate.get(SHAPE);
   ...
   protected void updateState(IBlockState state, World worldIn, BlockPos pos, Block blockIn) {
      ...
      if (flag1 != flag) {
         worldIn.setBlockState(pos, (IBlockState)state.with(POWERED, Boolean.valueOf(flag1)), 3);
