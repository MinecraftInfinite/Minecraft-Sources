...
public class BlockRedstoneOre extends Block {
   ...
   private static void activate(IBlockState p_196500_0_, World p_196500_1_, BlockPos p_196500_2_) {
      ...
      if (!p_196500_0_.get(LIT)) {
         p_196500_1_.setBlockState(p_196500_2_, (IBlockState)p_196500_0_.with(LIT, Boolean.valueOf(true)), 3);
      }
   ...
   public void tick(IBlockState state, World worldIn, BlockPos pos, Random random) {
      if (state.get(LIT)) {
         worldIn.setBlockState(pos, (IBlockState)state.with(LIT, Boolean.valueOf(false)), 3);
      }
