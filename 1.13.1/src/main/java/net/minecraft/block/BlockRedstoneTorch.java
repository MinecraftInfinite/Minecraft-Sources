...
public class BlockRedstoneTorch extends BlockTorch {
   ...
   private static final Map<IBlockReader, List<BlockRedstoneTorch.Toggle>> BURNED_TORCHES = Maps.<IBlockReader, List<BlockRedstoneTorch.Toggle>>newHashMap();

   protected BlockRedstoneTorch(Block.Properties properties) {
      super(properties);
      this.setDefaultState((IBlockState)(this.stateContainer.getBaseState()).with(LIT, Boolean.valueOf(true)));
   }
   ...
   public static void update(IBlockState p_196527_0_, World p_196527_1_, BlockPos p_196527_2_, Random p_196527_3_, boolean p_196527_4_) {
      ...
      if (p_196527_0_.get(LIT)) {
         if (p_196527_4_) {
            p_196527_1_.setBlockState(p_196527_2_, (IBlockState)p_196527_0_.with(LIT, Boolean.valueOf(false)), 3);
         ...
         p_196527_1_.setBlockState(p_196527_2_, (IBlockState)p_196527_0_.with(LIT, Boolean.valueOf(true)), 3);
      }
   ...
   private static boolean isBurnedOut(World p_176598_0_, BlockPos worldIn, boolean pos) {
      ...
      if (list == null) {
         list = Lists.<BlockRedstoneTorch.Toggle>newArrayList();
