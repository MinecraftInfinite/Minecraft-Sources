...
public class BlockRedstoneWire extends Block {
   ...
   public BlockRedstoneWire(Block.Properties properties) {
      super(properties);
      this.setDefaultState((IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)(this.stateContainer.getBaseState()).with(NORTH, RedstoneSide.NONE)).with(EAST, RedstoneSide.NONE)).with(SOUTH, RedstoneSide.NONE)).with(WEST, RedstoneSide.NONE)).with(POWER, Integer.valueOf(0)));
   }
   ...
   public void updateDiagonalNeighbors(IBlockState state, IWorld worldIn, BlockPos pos, int flags) {
      try (BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos = BlockPos.PooledMutableBlockPos.retain()) {
         for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
            RedstoneSide redstoneside = (RedstoneSide)state.get(FACING_PROPERTY_MAP.get(enumfacing));
   ...
   private IBlockState func_212568_b(World p_212568_1_, BlockPos p_212568_2_, IBlockState p_212568_3_) {
      ...
      if (i != j) {
         p_212568_3_ = (IBlockState)p_212568_3_.with(POWER, Integer.valueOf(j));
