   ...
   public static void checkWitherSpawn(World p_196298_0_, BlockPos p_196298_1_, TileEntitySkull p_196298_2_) {
      ...
      if (flag && p_196298_1_.getY() >= 2 && p_196298_0_.getDifficulty() != EnumDifficulty.PEACEFUL && !p_196298_0_.isRemote) {
         ...
         if (blockpattern$patternhelper != null) {
            ...
            for(int l = 0; l < 120; ++l) {
               p_196298_0_.addParticle(Particles.ITEM_SNOWBALL, (double)blockpos1.getX() + p_196298_0_.rand.nextDouble(), (double)(blockpos1.getY() - 2) + p_196298_0_.rand.nextDouble() * 3.9D, (double)blockpos1.getZ() + p_196298_0_.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
            }
