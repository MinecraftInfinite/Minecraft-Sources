...
public class BlockTurtleEgg extends Block {
   ...
   public BlockTurtleEgg(Block.Properties properties) {
      super(properties);
      this.setDefaultState((IBlockState)((IBlockState)(this.stateContainer.getBaseState()).with(HATCH, Integer.valueOf(0))).with(EGGS, Integer.valueOf(1)));
   }
   ...
   private void removeOneEgg(World p_203166_1_, BlockPos p_203166_2_, IBlockState p_203166_3_) {
      ...
      if (i <= 1) {
         ...
         p_203166_1_.setBlockState(p_203166_2_, (IBlockState)p_203166_3_.with(EGGS, Integer.valueOf(i - 1)), 2);
   ...
   public void tick(IBlockState state, World worldIn, BlockPos pos, Random random) {
      if (this.canGrow(worldIn) && this.hasProperHabitat(worldIn, pos)) {
         ...
         if (i < 2) {
            ...
            worldIn.setBlockState(pos, (IBlockState)state.with(HATCH, Integer.valueOf(i + 1)), 2);
         } else {
   ...
   public IBlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      return iblockstate.getBlock() == this ? (IBlockState)iblockstate.with(EGGS, Integer.valueOf(Math.min(4, iblockstate.get(EGGS) + 1))) : super.getStateForPlacement(context);
   }
