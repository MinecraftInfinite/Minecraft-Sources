...
public class BlockWall extends BlockFourWay {
   ...
   public BlockWall(Block.Properties properties) {
      ...
      this.setDefaultState((IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)(this.stateContainer.getBaseState()).with(UP, Boolean.valueOf(true))).with(NORTH, Boolean.valueOf(false))).with(EAST, Boolean.valueOf(false))).with(SOUTH, Boolean.valueOf(false))).with(WEST, Boolean.valueOf(false))).with(WATERLOGGED, Boolean.valueOf(false)));
   ...
   public IBlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      return (IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)this.getDefaultState().with(UP, Boolean.valueOf(flag4 || !iworldreaderbase.isAirBlock(blockpos.up())))).with(NORTH, Boolean.valueOf(flag))).with(EAST, Boolean.valueOf(flag1))).with(SOUTH, Boolean.valueOf(flag2))).with(WEST, Boolean.valueOf(flag3))).with(WATERLOGGED, Boolean.valueOf(ifluidstate.getFluid() == Fluids.WATER));
   }
   ...
   public IBlockState updatePostPlacement(IBlockState stateIn, EnumFacing facing, IBlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      ...
      if (facing == EnumFacing.DOWN) {
         ...
         boolean flag4 = (!flag || flag1 || !flag2 || flag3) && (flag || !flag1 || flag2 || !flag3);
         return (IBlockState)((IBlockState)((IBlockState)((IBlockState)((IBlockState)stateIn.with(UP, Boolean.valueOf(flag4 || !worldIn.isAirBlock(currentPos.up())))).with(NORTH, Boolean.valueOf(flag))).with(EAST, Boolean.valueOf(flag1))).with(SOUTH, Boolean.valueOf(flag2))).with(WEST, Boolean.valueOf(flag3));
      }
   }
