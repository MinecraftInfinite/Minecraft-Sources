...
public interface IBlockState extends IStateHolder<IBlockState> {
   ThreadLocal<Object2ByteMap<IBlockState>> PROPAGATES_SKYLIGHT_DOWN_CACHE = ThreadLocal.<Object2ByteMap<IBlockState>>withInitial(() -> {
   ...
   ThreadLocal<Object2ByteMap<IBlockState>> OPACITY_CACHE = ThreadLocal.<Object2ByteMap<IBlockState>>withInitial(() -> {
      Object2ByteOpenHashMap<IBlockState> object2byteopenhashmap = new Object2ByteOpenHashMap<IBlockState>();
      object2byteopenhashmap.defaultReturnValue((byte)127);
      return object2byteopenhashmap;
   });
   ThreadLocal<Object2ByteMap<IBlockState>> OPAQUE_CUBE_CACHE = ThreadLocal.<Object2ByteMap<IBlockState>>withInitial(() -> {
      Object2ByteOpenHashMap<IBlockState> object2byteopenhashmap = new Object2ByteOpenHashMap<IBlockState>();
      object2byteopenhashmap.defaultReturnValue((byte)127);
      return object2byteopenhashmap;
   });
   ...
   default boolean propagatesSkylightDown(IBlockReader worldIn, BlockPos pos) {
      ...
      Object2ByteMap<IBlockState> object2bytemap = block.isVariableOpacity() ? null : (Object2ByteMap)PROPAGATES_SKYLIGHT_DOWN_CACHE.get();
   ...
   default int getOpacity(IBlockReader worldIn, BlockPos pos) {
      Block block = this.getBlock();
      Object2ByteMap<IBlockState> object2bytemap = block.isVariableOpacity() ? null : (Object2ByteMap)OPACITY_CACHE.get();
      if (object2bytemap != null) {
         byte b0 = object2bytemap.getByte(this);
         if (b0 != object2bytemap.defaultReturnValue()) {
            return b0;
   ...
   default boolean isOpaqueCube(IBlockReader worldIn, BlockPos pos) {
      Block block = this.getBlock();
      Object2ByteMap<IBlockState> object2bytemap = block.isVariableOpacity() ? null : (Object2ByteMap)OPAQUE_CUBE_CACHE.get();
      if (object2bytemap != null) {
         byte b0 = object2bytemap.getByte(this);
         if (b0 != object2bytemap.defaultReturnValue()) {
            return b0 != 0;
