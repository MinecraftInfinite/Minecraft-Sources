...
public class GameSettings {
   ...
   public void saveOptions() {
      ...
      try {
         ...
         printwriter.println("version:1628");
         ...
         if (this.mc.mainWindow.getVideoMode().isPresent()) {
            printwriter.println("fullscreenResolution:" + ((VideoMode)this.mc.mainWindow.getVideoMode().get()).getSettingsString());
         }
   ...
   public void fillResourcePackList(ResourcePackList<ResourcePackInfoClient> resourcePackListIn) {
      ...
      Set<ResourcePackInfoClient> set = Sets.<ResourcePackInfoClient>newLinkedHashSet();
