...
public class Minecraft implements IThreadListener, ISnooperInfo, IGuiEventListenerDeferred {
   ...
   public Minecraft(GameConfiguration gameConfig) {
      ...
      this.resourcePackRepository = new ResourcePackList<ResourcePackInfoClient>((p_211818_0_, p_211818_1_, p_211818_2_, p_211818_3_, p_211818_4_, p_211818_5_) -> {
   ...
   private void populateSearchTreeManager() {
      SearchTree<ItemStack> searchtree = new SearchTree<ItemStack>((p_193988_0_) -> {
         return (List)p_193988_0_.getTooltip((EntityPlayer)null, ITooltipFlag.TooltipFlags.NORMAL).stream().map((p_211817_0_) -> {
      ...
      SearchTree<RecipeList> searchtree1 = new SearchTree<RecipeList>((p_193990_0_) -> {
         return (List)p_193990_0_.getRecipes().stream().flatMap((p_200240_0_) -> {
         ...
         return (List)p_193992_0_.getRecipes().stream().map((p_200237_0_) -> {
   ...
   public void refreshResources() {
      ...
      List<IResourcePack> list = (List)this.resourcePackRepository.getPackInfos().stream().<IResourcePack>map(ResourcePackInfo::getResourcePack).collect(Collectors.toList());
      ...
      try {
         ...
         this.resourcePackRepository.setEnabledPacks(Collections.<ResourcePackInfoClient>emptyList());
         List<IResourcePack> list1 = (List)this.resourcePackRepository.getPackInfos().stream().<IResourcePack>map(ResourcePackInfo::getResourcePack).collect(Collectors.toList());
