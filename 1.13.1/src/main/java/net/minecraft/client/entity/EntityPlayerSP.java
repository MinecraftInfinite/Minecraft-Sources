...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   private final List<IAmbientSoundHandler> ambientSoundHandlers = Lists.<IAmbientSoundHandler>newArrayList();
               ...
               if (!(f13 < -0.15F)) {
                  ...
                  if (iblockstate.getCollisionShape(this.world, blockpos).isEmpty()) {
                     ...
                     if (iblockstate1.getCollisionShape(this.world, blockpos).isEmpty()) {
                        ...
                        Iterator<AxisAlignedBB> iterator = this.world.func_212388_b(this, axisalignedbb).<AxisAlignedBB>flatMap((p_212329_0_) -> {
