...
public class GuiChat extends GuiScreen {
   ...
   private void updateUsageInfo() {
      if (((Suggestions)this.pendingSuggestions.join()).isEmpty() && !this.currentParse.getExceptions().isEmpty() && this.inputField.getCursorPosition() == this.inputField.getText().length()) {
         int i = 0;
   ...
   class SuggestionsList {
      ...
      public void render(int p_198500_1_, int p_198500_2_) {
         ...
         for(int l = 0; l < i; ++l) {
            Suggestion suggestion = (Suggestion)this.suggestions.getList().get(l + this.field_198507_d);
         ...
         if (flag4) {
            Message message = ((Suggestion)this.suggestions.getList().get(this.field_198508_e)).getTooltip();
            if (message != null) {
