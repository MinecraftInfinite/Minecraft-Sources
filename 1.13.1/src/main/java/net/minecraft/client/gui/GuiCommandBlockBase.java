...
public abstract class GuiCommandBlockBase extends GuiScreen {
   ...
   protected final List<String> field_209111_t = Lists.<String>newArrayList();
   ...
   private void func_209107_u() {
      if (((Suggestions)this.field_209115_x.join()).isEmpty() && !this.field_209114_w.getExceptions().isEmpty() && this.commandTextField.getCursorPosition() == this.commandTextField.getText().length()) {
         int i = 0;
   ...
   class SuggestionsList {
      ...
      private Vec2f lastMousePosition;
      ...
      private SuggestionsList(int p_i49843_2_, int p_i49843_3_, int p_i49843_4_, Suggestions p_i49843_5_) {
         this.lastMousePosition = Vec2f.ZERO;
      ...
      public void render(int mouseX, int mouseY) {
         ...
         if (flag4) {
            Message message = ((Suggestion)this.suggestions.getList().get(this.selectedSuggestion)).getTooltip();
            if (message != null) {
