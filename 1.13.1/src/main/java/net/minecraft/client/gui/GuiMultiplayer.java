...
public class GuiMultiplayer extends GuiScreen {
   ...
   public void createButtons() {
      this.btnEditServer = this.addButton(new GuiButton(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit")) {
         public void onClick(double mouseX, double mouseY) {
            GuiListExtended.IGuiListEntry<?> iguilistentry = GuiMultiplayer.this.serverListSelector.getSelected() < 0 ? null : (GuiListExtended.IGuiListEntry)GuiMultiplayer.this.serverListSelector.getChildren().get(GuiMultiplayer.this.serverListSelector.getSelected());
   ...
   public void confirmResult(boolean p_confirmResult_1_, int p_confirmResult_2_) {
      GuiListExtended.IGuiListEntry<?> iguilistentry = this.serverListSelector.getSelected() < 0 ? null : (GuiListExtended.IGuiListEntry)this.serverListSelector.getChildren().get(this.serverListSelector.getSelected());
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      ...
      GuiListExtended.IGuiListEntry<?> iguilistentry = i < 0 ? null : (GuiListExtended.IGuiListEntry)this.serverListSelector.getChildren().get(i);
   ...
   public void selectServer(int index) {
      ...
      GuiListExtended.IGuiListEntry<?> iguilistentry = index < 0 ? null : (GuiListExtended.IGuiListEntry)this.serverListSelector.getChildren().get(index);
