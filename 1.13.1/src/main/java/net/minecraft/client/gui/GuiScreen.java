...
public abstract class GuiScreen extends GuiEventHandler implements GuiYesNoCallback {
   ...
   protected final List<IGuiEventListener> children = Lists.<IGuiEventListener>newArrayList();
   protected Minecraft mc;
   protected ItemRenderer itemRender;
   public int width;
   public int height;
   protected final List<GuiButton> buttons = Lists.<GuiButton>newArrayList();
   protected final List<GuiLabel> labels = Lists.<GuiLabel>newArrayList();
