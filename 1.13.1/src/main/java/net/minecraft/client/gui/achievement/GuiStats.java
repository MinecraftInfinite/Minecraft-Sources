...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   class StatsGeneral extends GuiSlot {
      ...
      protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks) {
         ...
         ITextComponent itextcomponent = (new TextComponentTranslation("stat." + ((ResourceLocation)stat.getValue()).toString().replace(':', '.'), new Object[0])).applyTextStyle(TextFormatting.GRAY);
   ...
   class StatsItem extends GuiSlot {
      protected final List<StatType<Block>> field_195113_v = Lists.<StatType<Block>>newArrayList();
      ...
      public StatsItem(Minecraft mcIn) {
         ...
         Set<Item> set = Sets.<Item>newIdentityHashSet();
      ...
      protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks) {
         ...
         for(int i = 0; i < this.field_195113_v.size(); ++i) {
            ...
            if (item instanceof ItemBlock) {
               stat = ((StatType)this.field_195113_v.get(i)).get(((ItemBlock)item).getBlock());
            } else {
               stat = null;
            }
         ...
         if (mouseYIn >= this.top && mouseYIn <= this.bottom) {
            ...
            if (i >= 0) {
               ...
               for(int l = 0; l < this.field_195112_D.length; ++l) {
                  ...
                  if (k >= i1 - 18 && k <= i1) {
                     itextcomponent = new TextComponentTranslation(this.func_195108_d(l).getTranslationKey(), new Object[0]);
                     break;
                  }
               }
   ...
   class StatsMobsList extends GuiSlot {
      private final List<EntityType<?>> mobs = Lists.<EntityType<?>>newArrayList();
