...
public class Font implements AutoCloseable {
   ...
   private final List<IGlyphProvider> glyphProviders = Lists.<IGlyphProvider>newArrayList();
   private final Char2ObjectMap<TexturedGlyph> field_212463_j = new Char2ObjectOpenHashMap<TexturedGlyph>();
   private final Char2ObjectMap<IGlyph> glyphs = new Char2ObjectOpenHashMap<IGlyph>();
   ...
   public void setGlyphProviders(List<IGlyphProvider> glyphProvidersIn) {
      ...
      Set<IGlyphProvider> set = Sets.<IGlyphProvider>newHashSet();
         ...
         for(IGlyphProvider iglyphprovider1 : glyphProvidersIn) {
            ...
            if (iglyph != null) {
               ...
               if (iglyph != DefaultGlyph.INSTANCE) {
                  ((CharList)this.glyphsByWidth.computeIfAbsent(MathHelper.ceil(iglyph.getAdvance(false)), (p_212456_0_) -> {
