...
public class GuiContainerCreative extends InventoryEffectRenderer {
            ...
            if (hotbarsnapshot.isEmpty()) {
               for(int k = 0; k < 9; ++k) {
                  if (k == j) {
                     ...
                     itemstack.setDisplayName(new TextComponentTranslation("inventory.hotbarInfo", new Object[]{s1, s}));
   ...
   protected void renderToolTip(ItemStack stack, int x, int y) {
      if (selectedTabIndex == ItemGroup.SEARCH.getIndex()) {
         ...
         List<String> list1 = Lists.<String>newArrayListWithCapacity(list.size());
