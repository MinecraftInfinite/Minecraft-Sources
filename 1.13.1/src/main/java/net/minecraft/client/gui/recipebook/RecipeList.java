...
public class RecipeList {
   ...
   private final Set<IRecipe> craftable = Sets.<IRecipe>newHashSet();
   private final Set<IRecipe> canFit = Sets.<IRecipe>newHashSet();
   private final Set<IRecipe> inBook = Sets.<IRecipe>newHashSet();
