...
public class Main {
   ...
   public static void main(String[] p_main_0_) {
      ...
      String s = (String)func_206236_a(optionset, optionspec5);
      ...
      final String s1 = (String)func_206236_a(optionset, optionspec7);
      final String s2 = (String)func_206236_a(optionset, optionspec8);
      ...
      Optional<Integer> optional = Optional.<Integer>ofNullable(func_206236_a(optionset, optionspec15));
      ...
      PropertyMap propertymap1 = (PropertyMap)JsonUtils.fromJson(gson, (String)func_206236_a(optionset, optionspec18), PropertyMap.class);
      String s4 = (String)func_206236_a(optionset, optionspec21);
      File file1 = (File)func_206236_a(optionset, optionspec2);
      File file2 = optionset.has(optionspec3) ? (File)func_206236_a(optionset, optionspec3) : new File(file1, "assets/");
      File file3 = optionset.has(optionspec4) ? (File)func_206236_a(optionset, optionspec4) : new File(file1, "resourcepacks/");
      String s5 = optionset.has(optionspec10) ? (String)optionspec10.value(optionset) : EntityPlayer.getOfflineUUID(optionspec9.value(optionset)).toString();
      String s6 = optionset.has(optionspec19) ? (String)optionspec19.value(optionset) : null;
      String s7 = (String)func_206236_a(optionset, optionspec);
      Integer integer = (Integer)func_206236_a(optionset, optionspec1);
