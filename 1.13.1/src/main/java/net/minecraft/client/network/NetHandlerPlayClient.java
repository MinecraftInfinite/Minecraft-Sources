...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   private CommandDispatcher<ISuggestionProvider> commandDispatcher = new CommandDispatcher<ISuggestionProvider>();
   ...
   public void handleChangeGameState(SPacketChangeGameState packetIn) {
      ...
      if (i == 1) {
         ...
         if (f == 0.0F) {
            ...
            this.client.ingameGUI.getChatGUI().printChatMessage(new TextComponentTranslation("demo.help.movement", new Object[]{gamesettings.keyBindForward.func_197978_k(), gamesettings.keyBindLeft.func_197978_k(), gamesettings.keyBindBack.func_197978_k(), gamesettings.keyBindRight.func_197978_k()}));
         } else if (f == 102.0F) {
            this.client.ingameGUI.getChatGUI().printChatMessage(new TextComponentTranslation("demo.help.jump", new Object[]{gamesettings.keyBindJump.func_197978_k()}));
         } else if (f == 103.0F) {
            this.client.ingameGUI.getChatGUI().printChatMessage(new TextComponentTranslation("demo.help.inventory", new Object[]{gamesettings.keyBindInventory.func_197978_k()}));
         } else if (f == 104.0F) {
            this.client.ingameGUI.getChatGUI().printChatMessage(new TextComponentTranslation("demo.day.6", new Object[]{gamesettings.keyBindScreenshot.func_197978_k()}));
         }
      } else if (i == 6) {
