...
public class BlockModelRenderer {
   ...
   private static final ThreadLocal<Object2IntLinkedOpenHashMap<BlockPos>> CACHE_COMBINED_LIGHT = ThreadLocal.<Object2IntLinkedOpenHashMap<BlockPos>>withInitial(() -> {
   ...
   private static final ThreadLocal<Boolean> CACHE_ENABLED = ThreadLocal.<Boolean>withInitial(() -> {
      return false;
   });
   ...
   public static void disableCache() {
      ((Object2IntLinkedOpenHashMap)CACHE_COMBINED_LIGHT.get()).clear();
   ...
   public static enum EnumNeighborInfo {
      ...
      private static final BlockModelRenderer.EnumNeighborInfo[] VALUES = (BlockModelRenderer.EnumNeighborInfo[])Util.make(new BlockModelRenderer.EnumNeighborInfo[6], (p_209260_0_) -> {
   ...
   static enum VertexTranslations {
      ...
      private static final BlockModelRenderer.VertexTranslations[] VALUES = (BlockModelRenderer.VertexTranslations[])Util.make(new BlockModelRenderer.VertexTranslations[6], (p_209261_0_) -> {
