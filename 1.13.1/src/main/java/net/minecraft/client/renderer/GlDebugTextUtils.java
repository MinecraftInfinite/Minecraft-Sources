...
public class GlDebugTextUtils {
   ...
   private static final Map<Integer, String> GL_CONSTANT_NAMES = Maps.<Integer, String>newHashMap();
   private static final List<Integer> field_209257_h = ImmutableList.<Integer>of(37190, 37191, 37192, 33387);
   private static final List<Integer> field_209258_i = ImmutableList.<Integer>of(37190, 37191, 37192);
   private static final Map<String, List<String>> field_209259_j = Maps.<String, List<String>>newHashMap();
   ...
   public static void setDebugVerbosity(int debugVerbosity) {
      if (debugVerbosity > 0) {
         ...
         if (glcapabilities.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback((GLDebugMessageCallbackI)Util.make(GLDebugMessageCallback.create(GlDebugTextUtils::logDebugMessage), LWJGLMemoryUntracker::untrack), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB((GLDebugMessageARBCallbackI)Util.make(GLDebugMessageARBCallback.create(GlDebugTextUtils::logDebugMessage), LWJGLMemoryUntracker::untrack), 0L);
         }
