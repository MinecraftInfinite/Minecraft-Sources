...
public class GlStateManager {
   private static final FloatBuffer BUF_FLOAT_16 = (FloatBuffer)Util.make(MemoryUtil.memAllocFloat(16), (p_209238_0_) -> {
      LWJGLMemoryUntracker.untrack(MemoryUtil.memAddress(p_209238_0_));
   });
   private static final FloatBuffer BUF_FLOAT_4 = (FloatBuffer)Util.make(MemoryUtil.memAllocFloat(4), (p_209236_0_) -> {
   ...
   private static final GlStateManager.BooleanState[] LIGHTS = (GlStateManager.BooleanState[])IntStream.range(0, 8).mapToObj((p_199933_0_) -> {
   ...
   private static final GlStateManager.TextureState[] TEXTURES = (GlStateManager.TextureState[])IntStream.range(0, 8).mapToObj((p_199931_0_) -> {
