...
public final class VirtualScreen implements AutoCloseable {
   ...
   private final Map<Long, Monitor> monitorMap = Maps.<Long, Monitor>newHashMap();
   private final Map<Long, MainWindow> unusedMap = Maps.<Long, MainWindow>newHashMap();
   private final Map<MainWindow, Monitor> windowToMonitorMap = Maps.<MainWindow, Monitor>newHashMap();
