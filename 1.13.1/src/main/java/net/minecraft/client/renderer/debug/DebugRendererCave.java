...
public class DebugRendererCave implements DebugRenderer.IDebugRenderer {
   ...
   private final Map<BlockPos, BlockPos> subCaves = Maps.<BlockPos, BlockPos>newHashMap();
   private final Map<BlockPos, Float> sizes = Maps.<BlockPos, Float>newHashMap();
   private final List<BlockPos> caves = Lists.<BlockPos>newArrayList();
