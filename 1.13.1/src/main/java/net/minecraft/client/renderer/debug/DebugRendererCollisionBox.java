...
public class DebugRendererCollisionBox implements DebugRenderer.IDebugRenderer {
   ...
   private List<VoxelShape> collisionData = Collections.<VoxelShape>emptyList();
   ...
   public void render(float partialTicks, long finishTimeNano) {
      ...
      if (d0 - this.lastUpdate > 1.0E8D) {
         this.lastUpdate = d0;
         this.collisionData = (List)entityplayer.world.func_212388_b(entityplayer, entityplayer.getBoundingBox().grow(6.0D)).collect(Collectors.toList());
      }
