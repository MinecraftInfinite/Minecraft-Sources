...
public class RenderHorseChest extends RenderAbstractHorse<EntityHorse> {
   private static final Map<Class<?>, ResourceLocation> field_195635_a = Maps.<Class<?>, ResourceLocation>newHashMap(ImmutableMap.of(EntityDonkey.class, new ResourceLocation("textures/entity/horse/donkey.png"), EntityMule.class, new ResourceLocation("textures/entity/horse/mule.png")));
