...
public class RenderManager {
   ...
   public RenderManager(TextureManager renderEngineIn, ItemRenderer itemRendererIn) {
      ...
      this.entityRenderMap.put(EntitySpider.class, new RenderSpider<EntitySpider>(this));
      ...
      this.entityRenderMap.put(EntityMinecart.class, new RenderMinecart<EntityMinecart>(this));
