...
public class ModelBlockDefinition {
   private final Map<String, VariantList> mapVariants = Maps.<String, VariantList>newLinkedHashMap();
   private Multipart multipart;

   public static ModelBlockDefinition fromJson(ModelBlockDefinition.ContainerHolder containerHolderIn, Reader readerIn) {
      return (ModelBlockDefinition)JsonUtils.fromJson(containerHolderIn.gson, readerIn, ModelBlockDefinition.class);
   }
