...
public class TileEntitySkullRenderer extends TileEntityRenderer<TileEntitySkull> {
   ...
   private static final Map<BlockSkull.ISkullType, ModelBase> MODELS = (Map)Util.make(Maps.newHashMap(), (p_209262_0_) -> {
   ...
   private static final Map<BlockSkull.ISkullType, ResourceLocation> SKINS = (Map)Util.make(Maps.newHashMap(), (p_209263_0_) -> {
   ...
   public void render(TileEntitySkull tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
      ...
      EnumFacing enumfacing = flag ? (EnumFacing)iblockstate.get(BlockSkullWall.FACING) : null;
