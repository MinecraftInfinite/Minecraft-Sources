...
public class DownloadingPackFinder implements IPackFinder {
   ...
   public static Map<String, String> func_195742_b() {
      ...
      map.put("X-Minecraft-Version", "1.13.1");
      map.put("X-Minecraft-Pack-Format", String.valueOf((int)4));
      map.put("User-Agent", "Minecraft Java/1.13.1");
      return map;
   }
   ...
   public ListenableFuture<Object> func_195741_a(File p_195741_1_) {
      ...
      try (FilePack filepack = new FilePack(p_195741_1_)) {
         packmetadatasection = (PackMetadataSection)filepack.getMetadata(PackMetadataSection.SERIALIZER);
      ...
      if (packmetadatasection == null) {
         ...
         }, new TextComponentTranslation("resourcePack.server.name", new Object[0]), packmetadatasection.getDescription(), PackCompatibility.func_198969_a(packmetadatasection.getPackFormat()), ResourcePackInfo.Priority.TOP, true, nativeimage);
