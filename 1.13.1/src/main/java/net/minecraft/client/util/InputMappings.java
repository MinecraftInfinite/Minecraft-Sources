...
public class InputMappings {
   ...
   public static final class Input {
      ...
      private static final Map<String, InputMappings.Input> REGISTRY = Maps.<String, InputMappings.Input>newHashMap();
   ...
   public static enum Type {
      ...
      private final IntHashMap<InputMappings.Input> inputs = new IntHashMap<InputMappings.Input>();
      private final String name;
