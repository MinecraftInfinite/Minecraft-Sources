...
public class RecipeBookClient extends RecipeBook {
   ...
   private final Map<RecipeBookCategories, List<RecipeList>> recipesByCategory = Maps.<RecipeBookCategories, List<RecipeList>>newHashMap();
   private final List<RecipeList> allRecipes = Lists.<RecipeList>newArrayList();
   ...
   public void rebuildTable() {
      ...
      Table<RecipeBookCategories, String, RecipeList> table = HashBasedTable.<RecipeBookCategories, String, RecipeList>create();
   ...
   public List<RecipeList> getRecipes(RecipeBookCategories p_202891_1_) {
      return this.recipesByCategory.getOrDefault(p_202891_1_, Collections.<RecipeList>emptyList());
   }
}
