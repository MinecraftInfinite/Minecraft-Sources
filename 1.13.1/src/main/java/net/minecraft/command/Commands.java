...
public class Commands {
   ...
   public Commands(boolean isDedicatedServer) {
      ...
      this.dispatcher.setConsumer((p_197058_0_, p_197058_1_, p_197058_2_) -> {
         ((CommandSource)p_197058_0_.getSource()).onCommandComplete(p_197058_0_, p_197058_1_, p_197058_2_);
      });
   }
      ...
      try {
         try {
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
               ...
               itextcomponent1.appendSibling((new TextComponentTranslation("command.context.here", new Object[0])).applyTextStyles(new TextFormatting[]{TextFormatting.RED, TextFormatting.ITALIC}));
            ...
            source.sendErrorMessage((new TextComponentTranslation("command.failed", new Object[0])).applyTextStyle((p_211704_1_) -> {
