...
public class FunctionObject {
   ...
   public static FunctionObject create(ResourceLocation p_197000_0_, FunctionManager p_197000_1_, List<String> p_197000_2_) {
      List<FunctionObject.Entry> list = Lists.<FunctionObject.Entry>newArrayListWithCapacity(p_197000_2_.size());

      for(int i = 0; i < p_197000_2_.size(); ++i) {
         int j = i + 1;
         String s = ((String)p_197000_2_.get(i)).trim();
      ...
      return new FunctionObject(p_197000_0_, (FunctionObject.Entry[])list.toArray(new FunctionObject.Entry[0]));
   }
