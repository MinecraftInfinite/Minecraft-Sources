...
public class ColumnPosArgument implements ArgumentType<ILocationArgument> {
   private static final Collection<String> EXAMPLES = Arrays.<String>asList("0 0", "~ ~", "~1 ~-2", "^ ^", "^-1 ^0");
   ...
   public static ColumnPosArgument.ColumnPos getColumnPos(CommandContext<CommandSource> p_212602_0_, String p_212602_1_) {
      BlockPos blockpos = ((ILocationArgument)p_212602_0_.getArgument(p_212602_1_, ILocationArgument.class)).getBlockPos(p_212602_0_.getSource());
