...
public class DimensionArgument implements ArgumentType<DimensionType> {
   private static final Collection<String> EXAMPLES = (Collection)Stream.of(DimensionType.OVERWORLD, DimensionType.NETHER).<String>map((p_212593_0_) -> {
   ...
   public static final DynamicCommandExceptionType field_212596_a = new DynamicCommandExceptionType((p_212594_0_) -> {
      return new TextComponentTranslation("argument.dimension.invalid", new Object[]{p_212594_0_});
   });
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> p_listSuggestions_1_, SuggestionsBuilder p_listSuggestions_2_) {
      return ISuggestionProvider.func_212476_a(Streams.stream(DimensionType.func_212681_b()).map(DimensionType::getKey), p_listSuggestions_2_);
   }
