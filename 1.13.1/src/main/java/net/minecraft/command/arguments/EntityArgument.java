...
public class EntityArgument implements ArgumentType<EntitySelector> {
   private static final Collection<String> EXAMPLES = Arrays.<String>asList("Player", "0123", "@e", "@e[type=foo]", "dd12be42-52a9-4a91-a8a1-11c01849e498");
   public static final SimpleCommandExceptionType TOO_MANY_ENTITIES = new SimpleCommandExceptionType(new TextComponentTranslation("argument.entity.toomany", new Object[0]));
   public static final SimpleCommandExceptionType TOO_MANY_PLAYERS = new SimpleCommandExceptionType(new TextComponentTranslation("argument.player.toomany", new Object[0]));
   public static final SimpleCommandExceptionType ONLY_PLAYERS_ALLOWED = new SimpleCommandExceptionType(new TextComponentTranslation("argument.player.entities", new Object[0]));
   public static final SimpleCommandExceptionType ENTITY_NOT_FOUND = new SimpleCommandExceptionType(new TextComponentTranslation("argument.entity.notfound.entity", new Object[0]));
   public static final SimpleCommandExceptionType PLAYER_NOT_FOUND = new SimpleCommandExceptionType(new TextComponentTranslation("argument.entity.notfound.player", new Object[0]));
   ...
   public static Entity getEntity(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      return ((EntitySelector)context.getArgument(name, EntitySelector.class)).selectOne(context.getSource());
   }
   ...
   public static Collection<? extends Entity> getEntitiesAllowingNone(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      return ((EntitySelector)context.getArgument(name, EntitySelector.class)).select(context.getSource());
   }
   ...
   public static Collection<EntityPlayerMP> getPlayersAllowingNone(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      return ((EntitySelector)context.getArgument(name, EntitySelector.class)).selectPlayers(context.getSource());
   }
   ...
   public static EntityPlayerMP getPlayer(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      return ((EntitySelector)context.getArgument(name, EntitySelector.class)).selectOnePlayer(context.getSource());
   }
   ...
   public static Collection<EntityPlayerMP> getPlayers(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      List<EntityPlayerMP> list = ((EntitySelector)context.getArgument(name, EntitySelector.class)).selectPlayers(context.getSource());
      if (list.isEmpty()) {
