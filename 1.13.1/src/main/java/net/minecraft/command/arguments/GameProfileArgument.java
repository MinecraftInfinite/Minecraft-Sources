...
public class GameProfileArgument implements ArgumentType<GameProfileArgument.IProfileProvider> {
   private static final Collection<String> EXAMPLES = Arrays.<String>asList("Player", "0123", "dd12be42-52a9-4a91-a8a1-11c01849e498", "@e");
   public static final SimpleCommandExceptionType PLAYER_UNKNOWN = new SimpleCommandExceptionType(new TextComponentTranslation("argument.player.unknown", new Object[0]));
   ...
   public static Collection<GameProfile> getGameProfiles(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      return ((GameProfileArgument.IProfileProvider)context.getArgument(name, GameProfileArgument.IProfileProvider.class)).getNames(context.getSource());
   }
   ...
   public static class ProfileProvider implements GameProfileArgument.IProfileProvider {
      ...
      public Collection<GameProfile> getNames(CommandSource p_getNames_1_) throws CommandSyntaxException {
         ...
         if (list.isEmpty()) {
            ...
            List<GameProfile> list1 = Lists.<GameProfile>newArrayList();
