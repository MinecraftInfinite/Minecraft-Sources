...
public class ItemParser {
   ...
   public static final DynamicCommandExceptionType ITEM_BAD_ID = new DynamicCommandExceptionType((p_208696_0_) -> {
      return new TextComponentTranslation("argument.item.id.invalid", new Object[]{p_208696_0_});
   });
   ...
   private final Map<IProperty<?>, Comparable<?>> field_197336_d = Maps.<IProperty<?>, Comparable<?>>newHashMap();
   private Item item;
   @Nullable
