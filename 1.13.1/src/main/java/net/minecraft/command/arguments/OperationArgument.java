...
public class OperationArgument implements ArgumentType<OperationArgument.IOperation> {
   private static final Collection<String> EXAMPLES = Arrays.<String>asList("=", ">", "<");
   private static final SimpleCommandExceptionType OPERATION_INVALID = new SimpleCommandExceptionType(new TextComponentTranslation("arguments.operation.invalid", new Object[0]));
   private static final SimpleCommandExceptionType OPERATION_DIVIDE_BY_ZERO = new SimpleCommandExceptionType(new TextComponentTranslation("arguments.operation.div0", new Object[0]));
   ...
   public static OperationArgument.IOperation getOperation(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      return (OperationArgument.IOperation)context.getArgument(name, OperationArgument.IOperation.class);
   }
