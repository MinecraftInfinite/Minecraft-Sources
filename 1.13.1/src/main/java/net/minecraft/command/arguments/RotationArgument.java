...
public class RotationArgument implements ArgumentType<ILocationArgument> {
   private static final Collection<String> EXAMPLES = Arrays.<String>asList("0 0", "~ ~", "~-5 ~5");
   public static final SimpleCommandExceptionType ROTATION_INCOMPLETE = new SimpleCommandExceptionType(new TextComponentTranslation("argument.rotation.incomplete", new Object[0]));
