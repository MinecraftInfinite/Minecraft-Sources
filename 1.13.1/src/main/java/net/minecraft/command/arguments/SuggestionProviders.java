...
public class SuggestionProviders {
   private static final Map<ResourceLocation, SuggestionProvider<ISuggestionProvider>> REGISTRY = Maps.<ResourceLocation, SuggestionProvider<ISuggestionProvider>>newHashMap();
   ...
   public static final SuggestionProvider<CommandSource> ALL_RECIPES = register(new ResourceLocation("minecraft:all_recipes"), (p_197501_0_, p_197501_1_) -> {
      return ISuggestionProvider.suggestIterable(((ISuggestionProvider)p_197501_0_.getSource()).getRecipeResourceLocations(), p_197501_1_);
   });
   ...
   public static final SuggestionProvider<CommandSource> SUMMONABLE_ENTITIES = register(new ResourceLocation("minecraft:summonable_entities"), (p_201210_0_, p_201210_1_) -> {
      return ISuggestionProvider.func_201725_a(IRegistry.ENTITY_TYPE.stream().filter(EntityType::isSummonable), p_201210_1_, EntityType::getId, (p_201209_0_) -> {
         return new TextComponentTranslation(Util.makeTranslationKey("entity", EntityType.getId(p_201209_0_)), new Object[0]);
      });
   });
