...
public class Vec2Argument implements ArgumentType<ILocationArgument> {
   ...
   public static final SimpleCommandExceptionType VEC2_INCOMPLETE = new SimpleCommandExceptionType(new TextComponentTranslation("argument.pos2d.incomplete", new Object[0]));
   ...
   public static Vec2f getVec2f(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      Vec3d vec3d = ((ILocationArgument)context.getArgument(name, ILocationArgument.class)).getPosition(context.getSource());
