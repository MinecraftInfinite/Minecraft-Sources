...
public class CloneCommand {
   ...
   private static final Dynamic2CommandExceptionType CLONE_TOO_BIG_EXCEPTION = new Dynamic2CommandExceptionType((p_208796_0_, p_208796_1_) -> {
      return new TextComponentTranslation("commands.clone.toobig", new Object[]{p_208796_0_, p_208796_1_});
   });
   private static final SimpleCommandExceptionType FAILED_EXCEPTION = new SimpleCommandExceptionType(new TextComponentTranslation("commands.clone.failed", new Object[0]));
   public static final Predicate<BlockWorldState> NOT_AIR = (p_198275_0_) -> {
      return !p_198275_0_.getBlockState().isAir();
   };

   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("clone").requires((p_198271_0_) -> {
      ...
      if (!cloneMode.allowsOverlap() && mutableboundingbox1.intersectsWith(mutableboundingbox)) {
         ...
         if (i > 32768) {
            ...
            if (worldserver.isAreaLoaded(mutableboundingbox) && worldserver.isAreaLoaded(mutableboundingbox1)) {
               ...
               List<CloneCommand.BlockInfo> list1 = Lists.<CloneCommand.BlockInfo>newArrayList();
               ...
               list3.addAll(list1);
               list3.addAll(list2);
               List<CloneCommand.BlockInfo> list4 = Lists.<CloneCommand.BlockInfo>reverse(list3);
               ...
               if (i1 == 0) {
                  ...
                  source.sendFeedback(new TextComponentTranslation("commands.clone.success", new Object[]{i1}), true);
                  return i1;
               }
            } else {
