...
public class DebugCommand {
   ...
   private static final SimpleCommandExceptionType NOT_RUNNING_EXCEPTION = new SimpleCommandExceptionType(new TextComponentTranslation("commands.debug.notRunning", new Object[0]));
   private static final SimpleCommandExceptionType ALREADY_RUNNING_EXCEPTION = new SimpleCommandExceptionType(new TextComponentTranslation("commands.debug.alreadyRunning", new Object[0]));

   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("debug").requires((p_198332_0_) -> {
   ...
   private static int startDebug(CommandSource source) throws CommandSyntaxException {
      ...
      if (profiler.isProfiling()) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.debug.started", new Object[]{"Started the debug profiler. Type '/debug stop' to stop it."}), true);
         return 0;
      }
   }
   ...
   private static int stopDebug(CommandSource source) throws CommandSyntaxException {
      ...
      if (!profiler.isProfiling()) {
         ...
         float f1 = (float)l / f;
         source.sendFeedback(new TextComponentTranslation("commands.debug.stopped", new Object[]{String.format(Locale.ROOT, "%.2f", f), l, String.format("%.2f", f1)}), true);
