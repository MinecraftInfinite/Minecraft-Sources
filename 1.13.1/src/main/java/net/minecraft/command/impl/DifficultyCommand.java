...
public class DifficultyCommand {
   private static final DynamicCommandExceptionType FAILED_EXCEPTION = new DynamicCommandExceptionType((p_208823_0_) -> {
      return new TextComponentTranslation("commands.difficulty.failure", new Object[]{p_208823_0_});
   });
   ...
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      ...
      for(EnumDifficulty enumdifficulty : EnumDifficulty.values()) {
         literalargumentbuilder.then(Commands.literal(enumdifficulty.getTranslationKey()).executes((p_198347_1_) -> {
            return setDifficulty((CommandSource)p_198347_1_.getSource(), enumdifficulty);
         }));
      }

      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)literalargumentbuilder.requires((p_198348_0_) -> {
         return p_198348_0_.hasPermissionLevel(2);
      })).executes((p_198346_0_) -> {
         EnumDifficulty enumdifficulty1 = ((CommandSource)p_198346_0_.getSource()).getWorld().getDifficulty();
         ((CommandSource)p_198346_0_.getSource()).sendFeedback(new TextComponentTranslation("commands.difficulty.query", new Object[]{enumdifficulty1.getDisplayName()}), false);
   ...
   public static int setDifficulty(CommandSource source, EnumDifficulty difficulty) throws CommandSyntaxException {
      ...
      if (minecraftserver.getWorld(DimensionType.OVERWORLD).getDifficulty() == difficulty) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.difficulty.success", new Object[]{difficulty.getDisplayName()}), true);
         return 0;
      }
   }
}
