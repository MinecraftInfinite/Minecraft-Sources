...
public class FillCommand {
   private static final Dynamic2CommandExceptionType TOO_BIG_EXCEPTION = new Dynamic2CommandExceptionType((p_208897_0_, p_208897_1_) -> {
      return new TextComponentTranslation("commands.fill.toobig", new Object[]{p_208897_0_, p_208897_1_});
   });
   ...
   private static final SimpleCommandExceptionType FAILED_EXCEPTION = new SimpleCommandExceptionType(new TextComponentTranslation("commands.fill.failed", new Object[0]));

   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("fill").requires((p_198471_0_) -> {
   ...
   private static int doFill(CommandSource source, MutableBoundingBox area, BlockStateInput newBlock, FillCommand.Mode mode, @Nullable Predicate<BlockWorldState> replacingPredicate) throws CommandSyntaxException {
      ...
      if (i > 32768) {
         ...
         if (j == 0) {
            ...
            source.sendFeedback(new TextComponentTranslation("commands.fill.success", new Object[]{j}), true);
            return j;
         }
      }
   }
