...
public class KickCommand {
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("kick").requires((p_198517_0_) -> {
         ...
         return kickPlayers((CommandSource)p_198513_0_.getSource(), EntityArgument.getPlayers(p_198513_0_, "targets"), new TextComponentTranslation("multiplayer.disconnect.kicked", new Object[0]));
   ...
   private static int kickPlayers(CommandSource source, Collection<EntityPlayerMP> players, ITextComponent reason) {
      for(EntityPlayerMP entityplayermp : players) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.kick.success", new Object[]{entityplayermp.getDisplayName(), reason}), true);
      }
