...
public class SaveAllCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("save-all").requires((p_198615_0_) -> {
   ...
   private static int saveAll(CommandSource source, boolean flush) throws CommandSyntaxException {
      source.sendFeedback(new TextComponentTranslation("commands.save.saving", new Object[0]), false);
      ...
      if (!flag) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.save.success", new Object[0]), true);
         return 1;
      }
   }
