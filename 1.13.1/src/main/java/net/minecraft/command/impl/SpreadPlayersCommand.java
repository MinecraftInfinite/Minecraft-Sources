...
public class SpreadPlayersCommand {
   private static final Dynamic4CommandExceptionType SPREAD_TEAMS_FAILED = new Dynamic4CommandExceptionType((p_208910_0_, p_208910_1_, p_208910_2_, p_208910_3_) -> {
      return new TextComponentTranslation("commands.spreadplayers.failed.teams", new Object[]{p_208910_0_, p_208910_1_, p_208910_2_, p_208910_3_});
   });
   private static final Dynamic4CommandExceptionType SPREAD_ENTITIES_FAILED = new Dynamic4CommandExceptionType((p_208912_0_, p_208912_1_, p_208912_2_, p_208912_3_) -> {
      return new TextComponentTranslation("commands.spreadplayers.failed.entities", new Object[]{p_208912_0_, p_208912_1_, p_208912_2_, p_208912_3_});
   });

   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spreadplayers").requires((p_198721_0_) -> {
   ...
   private static int spreadPlayers(CommandSource source, Vec2f center, float spreadDistance, float maxRange, boolean respectTeams, Collection<? extends Entity> targets) throws CommandSyntaxException {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.spreadplayers.success." + (respectTeams ? "teams" : "entities"), new Object[]{aspreadplayerscommand$position.length, center.x, center.y, String.format(Locale.ROOT, "%.2f", d4)}), true);
