...
public class WorldBorderCommand {
   private static final SimpleCommandExceptionType CENTER_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.center.failed", new Object[0]));
   private static final SimpleCommandExceptionType SIZE_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.set.failed.nochange", new Object[0]));
   private static final SimpleCommandExceptionType SIZE_TOO_SMALL = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.set.failed.small.", new Object[0]));
   private static final SimpleCommandExceptionType SIZE_TOO_BIG = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.set.failed.big.", new Object[0]));
   private static final SimpleCommandExceptionType WARNING_TIME_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.warning.time.failed", new Object[0]));
   private static final SimpleCommandExceptionType WARNING_DISTANCE_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.warning.distance.failed", new Object[0]));
   private static final SimpleCommandExceptionType DAMAGE_BUFFER_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.damage.buffer.failed", new Object[0]));
   private static final SimpleCommandExceptionType DAMAGE_AMOUNT_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.worldborder.damage.amount.failed", new Object[0]));

   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("worldborder").requires((p_198903_0_) -> {
   ...
   private static int setDamageBuffer(CommandSource source, float distance) throws CommandSyntaxException {
      ...
      if (worldborder.getDamageBuffer() == (double)distance) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.worldborder.damage.buffer.success", new Object[]{String.format(Locale.ROOT, "%.2f", distance)}), true);
         return (int)distance;
      }
   }
   ...
   private static int setDamageAmount(CommandSource source, float damagePerBlock) throws CommandSyntaxException {
      ...
      if (worldborder.getDamagePerBlock() == (double)damagePerBlock) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.worldborder.damage.amount.success", new Object[]{String.format(Locale.ROOT, "%.2f", damagePerBlock)}), true);
   ...
   private static int setWarningTime(CommandSource source, int time) throws CommandSyntaxException {
      ...
      if (worldborder.getWarningTime() == time) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.worldborder.warning.time.success", new Object[]{time}), true);
         return time;
      }
   }
   ...
   private static int setWarningDistance(CommandSource source, int distance) throws CommandSyntaxException {
      ...
      if (worldborder.getWarningDistance() == distance) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.worldborder.warning.distance.success", new Object[]{distance}), true);
         return distance;
      }
   }
   ...
   private static int getSize(CommandSource source) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.worldborder.get", new Object[]{String.format(Locale.ROOT, "%.0f", d0)}), false);
   ...
   private static int setCenter(CommandSource source, Vec2f pos) throws CommandSyntaxException {
      ...
      if (worldborder.getCenterX() == (double)pos.x && worldborder.getCenterZ() == (double)pos.y) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.worldborder.center.success", new Object[]{String.format(Locale.ROOT, "%.2f", pos.x), String.format("%.2f", pos.y)}), true);
         return 0;
      }
   }
   ...
   private static int setSize(CommandSource source, double newSize, long time) throws CommandSyntaxException {
      ...
      if (d0 == newSize) {
         ...
         if (time > 0L) {
            ...
            if (newSize > d0) {
               source.sendFeedback(new TextComponentTranslation("commands.worldborder.set.grow", new Object[]{String.format(Locale.ROOT, "%.1f", newSize), Long.toString(time / 1000L)}), true);
            } else {
               source.sendFeedback(new TextComponentTranslation("commands.worldborder.set.shrink", new Object[]{String.format(Locale.ROOT, "%.1f", newSize), Long.toString(time / 1000L)}), true);
            }
         } else {
            worldborder.setTransition(newSize);
            source.sendFeedback(new TextComponentTranslation("commands.worldborder.set.immediate", new Object[]{String.format(Locale.ROOT, "%.1f", newSize)}), true);
         }
