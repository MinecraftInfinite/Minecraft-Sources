...
public class DirectoryCache {
   ...
   private int hits;
   private final Map<Path, String> staleFiles = Maps.<Path, String>newHashMap();
   private final Map<Path, String> createdFiles = Maps.<Path, String>newHashMap();
   ...
   public void writeCache() throws IOException {
      ...
      IOUtils.writeLines((Collection)this.createdFiles.entrySet().stream().map((p_208319_1_) -> {
         return (String)p_208319_1_.getValue() + ' ' + this.outputFolder.relativize((Path)p_208319_1_.getKey());
