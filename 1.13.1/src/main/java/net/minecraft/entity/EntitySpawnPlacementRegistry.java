...
public class EntitySpawnPlacementRegistry {
   private static final Map<EntityType<?>, EntitySpawnPlacementRegistry.Entry> REGISTRY = Maps.<EntityType<?>, EntitySpawnPlacementRegistry.Entry>newHashMap();
   ...
   private static void register(EntityType<?> entityTypeIn, EntitySpawnPlacementRegistry.SpawnPlacementType placementType, Heightmap.Type heightMapType) {
      register(entityTypeIn, placementType, heightMapType, (Tag)null);
   }
