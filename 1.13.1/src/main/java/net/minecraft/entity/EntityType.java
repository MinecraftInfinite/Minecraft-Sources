...
public class EntityType<T extends Entity> {
   ...
   public static EntityType<?> getById(String id) {
      return IRegistry.ENTITY_TYPE.get(ResourceLocation.makeResourceLocation(id));
   }
   ...
   public ITextComponent func_212546_e() {
      if (this.field_212547_aX == null) {
         this.field_212547_aX = new TextComponentTranslation(this.getTranslationKey(), new Object[0]);
      }
   ...
   public static class Builder<T extends Entity> {
      ...
      public static <T extends Entity> EntityType.Builder<T> create(Class<? extends T> entityClassIn, Function<? super World, ? extends T> factoryIn) {
         return new EntityType.Builder<T>(entityClassIn, factoryIn);
      }

      public static <T extends Entity> EntityType.Builder<T> createNothing(Class<? extends T> entityClassIn) {
         return new EntityType.Builder<T>(entityClassIn, (p_200708_0_) -> {
            return null;
         });
      }
      ...
      public EntityType<T> build(String id) {
         ...
         if (this.serializable) {
            try {
               type = DataFixesManager.getDataFixer().getSchema(DataFixUtils.makeKey(1628)).getChoiceType(TypeReferences.ENTITY_TYPE, id);
