...
public class EntityWither extends EntityMob implements IRangedAttackMob {
   ...
   private static final List<DataParameter<Integer>> HEAD_TARGETS = ImmutableList.<DataParameter<Integer>>of(FIRST_HEAD_TARGET, SECOND_HEAD_TARGET, THIRD_HEAD_TARGET);
         ...
         for(int i = 1; i < 3; ++i) {
            if (this.ticksExisted >= this.nextHeadUpdate[i - 1]) {
               ...
               if (k1 > 0) {
                  ...
                  List<EntityLivingBase> list = this.world.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, this.getBoundingBox().grow(20.0D, 8.0D, 20.0D), NOT_UNDEAD.and(EntitySelectors.NOT_SPECTATING));
