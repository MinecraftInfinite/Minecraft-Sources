...
public class PhaseDying extends PhaseBase {
   ...
   public void clientTick() {
      if (this.time++ % 10 == 0) {
         ...
         this.dragon.world.addParticle(Particles.EXPLOSION_EMITTER, this.dragon.posX + (double)f, this.dragon.posY + 2.0D + (double)f1, this.dragon.posZ + (double)f2, 0.0D, 0.0D, 0.0D);
      }
