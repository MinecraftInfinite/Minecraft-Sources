...
public class EntityBoat extends Entity {
   ...
   private static final DataParameter<Boolean> field_199704_e = EntityDataManager.<Boolean>createKey(EntityBoat.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> field_199705_f = EntityDataManager.<Boolean>createKey(EntityBoat.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> ROCKING_TICKS = EntityDataManager.<Integer>createKey(EntityBoat.class, DataSerializers.VARINT);
   ...
   public boolean getPaddleState(int side) {
      return this.dataManager.get(side == 0 ? field_199704_e : field_199705_f) && this.getControllingPassenger() != null;
   }
