...
public class EntityMinecartFurnace extends EntityMinecart {
   ...
   public IBlockState getDefaultDisplayTile() {
      return (IBlockState)((IBlockState)Blocks.FURNACE.getDefaultState().with(BlockFurnace.FACING, EnumFacing.NORTH)).with(BlockFurnace.LIT, Boolean.valueOf(this.isMinecartPowered()));
   }
}
