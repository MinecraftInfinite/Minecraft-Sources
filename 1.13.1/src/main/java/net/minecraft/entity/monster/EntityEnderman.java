...
public class EntityEnderman extends EntityMob {
   ...
   public IBlockState func_195405_dq() {
      return (IBlockState)((Optional)this.dataManager.get(CARRIED_BLOCK)).orElse((Object)null);
   }
   ...
   static class AIFindPlayer extends EntityAINearestAttackableTarget<EntityPlayer> {
      ...
      public boolean shouldExecute() {
         ...
         this.player = this.enderman.world.getNearestAttackablePlayer(this.enderman.posX, this.enderman.posY, this.enderman.posZ, d0, d0, (Function)null, (p_210295_1_) -> {
