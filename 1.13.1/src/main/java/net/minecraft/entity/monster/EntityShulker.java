...
public class EntityShulker extends EntityGolem implements IMob {
   ...
   public void tick() {
      super.tick();
      BlockPos blockpos = (BlockPos)((Optional)this.dataManager.get(ATTACHED_BLOCK_POS)).orElse((Object)null);
   ...
   public BlockPos getAttachmentPos() {
      return (BlockPos)((Optional)this.dataManager.get(ATTACHED_BLOCK_POS)).orElse((Object)null);
   }
