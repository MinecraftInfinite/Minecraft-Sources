...
public class EntityDolphin extends EntityWaterMob {
   private static final DataParameter<BlockPos> TREASURE_POS = EntityDataManager.<BlockPos>createKey(EntityDolphin.class, DataSerializers.BLOCK_POS);
   private static final DataParameter<Boolean> GOT_FISH = EntityDataManager.<Boolean>createKey(EntityDolphin.class, DataSerializers.BOOLEAN);
   ...
   class AIPlayWithItems extends EntityAIBase {
      ...
      public boolean shouldExecute() {
         if (this.field_205154_b > EntityDolphin.this.ticksExisted) {
            ...
            List<EntityItem> list = EntityDolphin.this.world.<EntityItem>getEntitiesWithinAABB(EntityItem.class, EntityDolphin.this.getBoundingBox().grow(8.0D, 8.0D, 8.0D), EntityDolphin.ITEM_SELECTOR);
