...
public class EntityParrot extends EntityShoulderRiding implements IFlyingAnimal {
   ...
   private static final Map<EntityType<?>, SoundEvent> IMITATION_SOUND_EVENTS = (Map)Util.make(Maps.newHashMap(), (p_200609_0_) -> {
   ...
   public boolean canSpawn(IWorld worldIn, boolean p_205020_2_) {
      ...
      return block instanceof BlockLeaves || block == Blocks.GRASS || block instanceof BlockLog || block == Blocks.AIR && super.canSpawn(worldIn, p_205020_2_);
   }
