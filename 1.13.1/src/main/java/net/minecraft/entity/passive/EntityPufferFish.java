...
public class EntityPufferFish extends AbstractFish {
   private static final DataParameter<Integer> PUFF_STATE = EntityDataManager.<Integer>createKey(EntityPufferFish.class, DataSerializers.VARINT);
   ...
   static class AIPuff extends EntityAIBase {
      ...
      public boolean shouldExecute() {
         List<EntityLivingBase> list = this.field_203789_a.world.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, this.field_203789_a.getBoundingBox().grow(2.0D), EntityPufferFish.ENEMY_MATCHER);
         return !list.isEmpty();
      }
