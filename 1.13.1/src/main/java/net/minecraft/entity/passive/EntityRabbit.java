...
public class EntityRabbit extends EntityAnimal {
   ...
   public void setRabbitType(int rabbitTypeId) {
      if (rabbitTypeId == 99) {
         ...
         if (!this.hasCustomName()) {
            this.setCustomName(new TextComponentTranslation(Util.makeTranslationKey("entity", field_200611_bx), new Object[0]));
         }
      }
   ...
   public boolean canSpawn(IWorld worldIn, boolean p_205020_2_) {
      ...
      return block != Blocks.GRASS && block != Blocks.SNOW && block != Blocks.SAND ? super.canSpawn(worldIn, p_205020_2_) : true;
   }
         ...
         if (this.getIsAboveDestination()) {
            ...
            if (this.canRaid && block instanceof BlockCarrot) {
               ...
               if (integer == 0) {
                  ...
                  world.setBlockState(blockpos, (IBlockState)iblockstate.with(BlockCarrot.AGE, Integer.valueOf(integer - 1)), 2);
