...
public class EntityTropicalFish extends AbstractFish {
   private static final DataParameter<Integer> VARIANT = EntityDataManager.<Integer>createKey(EntityTropicalFish.class, DataSerializers.VARINT);
   ...
   public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData entityLivingData, @Nullable NBTTagCompound itemNbt) {
      ...
      if (itemNbt != null && itemNbt.contains("BucketVariantTag", 3)) {
         ...
         if (entityLivingData instanceof EntityTropicalFish.GroupData) {
            ...
            k = (i1 & 16711680) >> 16;
            l = (i1 & -16777216) >> 24;
            entityLivingData = new EntityTropicalFish.GroupData(i, j, k, l);
         } else {
   ...
   static class GroupData implements IEntityLivingData {
      ...
      private GroupData(int p_i48880_1_, int p_i48880_2_, int p_i48880_3_, int p_i48880_4_) {
         this.size = p_i48880_1_;
         this.pattern = p_i48880_2_;
         this.bodyColor = p_i48880_3_;
         this.patternColor = p_i48880_4_;
      }
   }
