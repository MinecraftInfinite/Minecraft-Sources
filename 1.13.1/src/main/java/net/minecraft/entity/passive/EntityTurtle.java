...
public class EntityTurtle extends EntityAnimal {
   private static final DataParameter<BlockPos> HOME_POS = EntityDataManager.<BlockPos>createKey(EntityTurtle.class, DataSerializers.BLOCK_POS);
   private static final DataParameter<Boolean> HAS_EGG = EntityDataManager.<Boolean>createKey(EntityTurtle.class, DataSerializers.BOOLEAN);
   ...
   private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.<BlockPos>createKey(EntityTurtle.class, DataSerializers.BLOCK_POS);
   private static final DataParameter<Boolean> GOING_HOME = EntityDataManager.<Boolean>createKey(EntityTurtle.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.<Boolean>createKey(EntityTurtle.class, DataSerializers.BOOLEAN);
   ...
   static class AIGoHome extends EntityAIBase {
      ...
      public void tick() {
         ...
         if (this.turtle.func_203016_dz() || this.turtle.getNavigator().noPath()) {
   ...
   static class AITravel extends EntityAIBase {
      ...
      public boolean shouldContinueExecuting() {
         return this.turtle.getDistanceSq(this.turtle.getTravelPos()) >= 36.0D && !this.field_203139_c && !this.turtle.isGoingHome() && !this.turtle.isInLove() && !this.turtle.hasEgg();
      }
