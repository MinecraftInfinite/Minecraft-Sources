...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public void writeAdditional(NBTTagCompound compound) {
      ...
      compound.putInt("DataVersion", 1628);
   ...
   public void wakeUpPlayer(boolean immediately, boolean updateWorldFlag, boolean setSpawn) {
      ...
      if (this.bedLocation != null && iblockstate.getBlock() instanceof BlockBed) {
         this.world.setBlockState(this.bedLocation, (IBlockState)iblockstate.with(BlockBed.OCCUPIED, Boolean.valueOf(false)), 4);
   ...
   public static enum EnumChatVisibility {
      ...
      private static final EntityPlayer.EnumChatVisibility[] ID_LOOKUP = (EntityPlayer.EnumChatVisibility[])Arrays.stream(values()).sorted(Comparator.comparingInt(EntityPlayer.EnumChatVisibility::getChatVisibility)).toArray((p_199765_0_) -> {
