...
public class InventoryPlayer implements IInventory {
   ...
   public InventoryPlayer(EntityPlayer playerIn) {
      this.allInventories = ImmutableList.<NonNullList<ItemStack>>of(this.mainInventory, this.armorInventory, this.offHandInventory);
   ...
   public float getDestroySpeed(IBlockState state) {
      return ((ItemStack)this.mainInventory.get(this.currentItem)).getDestroySpeed(state);
   }
