...
public abstract class EntityArrow extends Entity implements IProjectile {
   ...
   protected static final DataParameter<Optional<UUID>> field_212362_a = EntityDataManager.<Optional<UUID>>createKey(EntityArrow.class, DataSerializers.OPTIONAL_UNIQUE_ID);
   private int xTile;
   private int yTile;
   private int zTile;
   @Nullable
