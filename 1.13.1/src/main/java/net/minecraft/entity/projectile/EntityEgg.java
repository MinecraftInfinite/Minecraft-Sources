...
public class EntityEgg extends EntityThrowable {
   ...
   public void handleStatusUpdate(byte id) {
      if (id == 3) {
         ...
         for(int i = 0; i < 8; ++i) {
            this.world.addParticle(new ItemParticleData(Particles.ITEM, new ItemStack(Items.EGG)), this.posX, this.posY, this.posZ, ((double)this.rand.nextFloat() - 0.5D) * 0.08D, ((double)this.rand.nextFloat() - 0.5D) * 0.08D, ((double)this.rand.nextFloat() - 0.5D) * 0.08D);
         }
      }
