...
public final class ProjectileHelper {
   public static RayTraceResult forwardsRaycast(Entity projectile, boolean includeEntities, boolean ignoreExcludedEntity, @Nullable Entity excludedEntity) {
      ...
      if (!world.isCollisionBoxesEmpty(projectile, projectile.getBoundingBox(), (Set)(!ignoreExcludedEntity && excludedEntity != null ? func_211325_a(excludedEntity) : ImmutableSet.of()))) {
