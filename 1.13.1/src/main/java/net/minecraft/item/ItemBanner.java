      ...
      if (nbttagcompound != null && nbttagcompound.contains("Patterns")) {
         ...
         for(int i = 0; i < nbttaglist.size() && i < 6; ++i) {
            ...
            if (bannerpattern != null) {
               p_185054_1_.add((new TextComponentTranslation("block.minecraft.banner." + bannerpattern.getFileName() + '.' + enumdyecolor.getTranslationKey(), new Object[0])).applyTextStyle(TextFormatting.GRAY));
            }
         }
