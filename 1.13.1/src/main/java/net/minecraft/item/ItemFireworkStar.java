...
public class ItemFireworkStar extends Item {
   ...
   public static void func_195967_a(NBTTagCompound p_195967_0_, List<ITextComponent> p_195967_1_) {
      ...
      p_195967_1_.add((new TextComponentTranslation("item.minecraft.firework_star.shape." + itemfireworkrocket$shape.func_196068_b(), new Object[0])).applyTextStyle(TextFormatting.GRAY));
      ...
      if (aint1.length > 0) {
         p_195967_1_.add(func_200298_a((new TextComponentTranslation("item.minecraft.firework_star.fade_to", new Object[0])).appendText(" ").applyTextStyle(TextFormatting.GRAY), aint1));
      }

      if (p_195967_0_.getBoolean("Trail")) {
         p_195967_1_.add((new TextComponentTranslation("item.minecraft.firework_star.trail", new Object[0])).applyTextStyle(TextFormatting.GRAY));
      }

      if (p_195967_0_.getBoolean("Flicker")) {
         p_195967_1_.add((new TextComponentTranslation("item.minecraft.firework_star.flicker", new Object[0])).applyTextStyle(TextFormatting.GRAY));
      }
   ...
   private static ITextComponent func_200297_a(int p_200297_0_) {
      ...
      return enumdyecolor == null ? new TextComponentTranslation("item.minecraft.firework_star.custom_color", new Object[0]) : new TextComponentTranslation("item.minecraft.firework_star." + enumdyecolor.getTranslationKey(), new Object[0]);
   }
}
