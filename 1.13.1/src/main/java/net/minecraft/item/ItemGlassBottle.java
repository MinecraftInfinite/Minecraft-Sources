...
public class ItemGlassBottle extends Item {
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
      List<EntityAreaEffectCloud> list = worldIn.<EntityAreaEffectCloud>getEntitiesWithinAABB(EntityAreaEffectCloud.class, playerIn.getBoundingBox().grow(2.0D), (p_210311_0_) -> {
         ...
         if (raytraceresult == null) {
            ...
            if (raytraceresult.type == RayTraceResult.Type.BLOCK) {
               ...
               if (worldIn.getFluidState(blockpos).isTagged(FluidTags.WATER)) {
                  ...
                  return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, this.turnBottleIntoItem(itemstack, playerIn, PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), PotionTypes.WATER)));
               }
            }
