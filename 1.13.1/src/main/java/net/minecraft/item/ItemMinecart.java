...
public class ItemMinecart extends Item {
   private static final IBehaviorDispenseItem MINECART_DISPENSER_BEHAVIOR = new BehaviorDefaultDispenseItem() {
      ...
      public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
         ...
         RailShape railshape = iblockstate.getBlock() instanceof BlockRailBase ? (RailShape)iblockstate.get(((BlockRailBase)iblockstate.getBlock()).getShapeProperty()) : RailShape.NORTH_SOUTH;
         double d3;
         if (iblockstate.isIn(BlockTags.RAILS)) {
            ...
            RailShape railshape1 = iblockstate1.getBlock() instanceof BlockRailBase ? (RailShape)iblockstate1.get(((BlockRailBase)iblockstate1.getBlock()).getShapeProperty()) : RailShape.NORTH_SOUTH;
