...
public class ItemWrittenBook extends Item {
   ...
   public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
      if (stack.hasTag()) {
         ...
         if (!StringUtils.isNullOrEmpty(s)) {
            tooltip.add((new TextComponentTranslation("book.byAuthor", new Object[]{s})).applyTextStyle(TextFormatting.GRAY));
         }

         tooltip.add((new TextComponentTranslation("book.generation." + nbttagcompound.getInt("generation"), new Object[0])).applyTextStyle(TextFormatting.GRAY));
      }
