...
public final class Ingredient implements Predicate<ItemStack> {
   ...
   private Ingredient(Stream<? extends Ingredient.IItemList> itemLists) {
      this.acceptedItems = (Ingredient.IItemList[])itemLists.filter(IS_EMPTY).toArray((p_209360_0_) -> {
   ...
   private void determineMatchingStacks() {
      if (this.matchingStacks == null) {
         this.matchingStacks = (ItemStack[])Arrays.stream(this.acceptedItems).flatMap((p_209359_0_) -> {
