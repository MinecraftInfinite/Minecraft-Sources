...
public class RecipeBook {
   protected final Set<ResourceLocation> recipes = Sets.<ResourceLocation>newHashSet();
   protected final Set<ResourceLocation> newRecipes = Sets.<ResourceLocation>newHashSet();
