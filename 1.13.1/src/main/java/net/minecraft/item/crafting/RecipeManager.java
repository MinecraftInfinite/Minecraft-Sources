...
public class RecipeManager implements IResourceManagerReloadListener {
   ...
   private final Map<ResourceLocation, IRecipe> recipes = Maps.<ResourceLocation, IRecipe>newHashMap();
   ...
   public NonNullList<ItemStack> getRemainingItems(IInventory input, World worldIn) {
      ...
      NonNullList<ItemStack> nonnulllist = NonNullList.<ItemStack>withSize(input.getSizeInventory(), ItemStack.EMPTY);
