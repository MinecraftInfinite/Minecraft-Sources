...
public class NBTTagList extends NBTTagCollection<INBTBase> {
   ...
   private List<INBTBase> tagList = Lists.<INBTBase>newArrayList();
   ...
   public void write(DataOutput output) throws IOException {
      if (this.tagList.isEmpty()) {
         ...
         this.tagType = ((INBTBase)this.tagList.get(0)).getId();
      }
      ...
      for(int i = 0; i < this.tagList.size(); ++i) {
         ((INBTBase)this.tagList.get(i)).write(output);
      }
   ...
   public void read(DataInput input, int depth, NBTSizeTracker sizeTracker) throws IOException {
      ...
      if (depth > 512) {
         ...
         if (this.tagType == 0 && i > 0) {
            ...
            this.tagList = Lists.<INBTBase>newArrayListWithCapacity(i);
   ...
   public INBTBase get(int p_get_1_) {
      return (INBTBase)(p_get_1_ >= 0 && p_get_1_ < this.tagList.size() ? (INBTBase)this.tagList.get(p_get_1_) : new NBTTagEnd());
   }
   ...
   public ITextComponent toFormattedComponent(String indentation, int indentDepth) {
      if (this.isEmpty()) {
         ...
         for(int i = 0; i < this.tagList.size(); ++i) {
            ...
            itextcomponent1.appendSibling(((INBTBase)this.tagList.get(i)).toFormattedComponent(indentation, indentDepth + 1));
