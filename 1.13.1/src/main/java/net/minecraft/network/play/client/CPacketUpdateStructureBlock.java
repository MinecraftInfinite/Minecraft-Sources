...
public class CPacketUpdateStructureBlock implements Packet<INetHandlerPlayServer> {
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      this.field_210392_b = (TileEntityStructure.UpdateCommand)buf.readEnumValue(TileEntityStructure.UpdateCommand.class);
      this.mode = (StructureMode)buf.readEnumValue(StructureMode.class);
      ...
      this.mirror = (Mirror)buf.readEnumValue(Mirror.class);
      this.rotation = (Rotation)buf.readEnumValue(Rotation.class);
