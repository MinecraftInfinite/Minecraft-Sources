...
public class SPacketCommandList implements Packet<INetHandlerPlayClient> {
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      Deque<SPacketCommandList.Entry> deque = new ArrayDeque<SPacketCommandList.Entry>(aspacketcommandlist$entry.length);
      ...
      while(!deque.isEmpty()) {
         ...
         while(iterator.hasNext()) {
            ...
            if (spacketcommandlist$entry.createCommandNode(aspacketcommandlist$entry)) {
               iterator.remove();
               flag = true;
            }
         }
   ...
   public void writePacketData(PacketBuffer buf) throws IOException {
      Map<CommandNode<ISuggestionProvider>, Integer> map = Maps.<CommandNode<ISuggestionProvider>, Integer>newHashMap();
      Deque<CommandNode<ISuggestionProvider>> deque = new ArrayDeque<CommandNode<ISuggestionProvider>>();
      deque.add(this.root);
