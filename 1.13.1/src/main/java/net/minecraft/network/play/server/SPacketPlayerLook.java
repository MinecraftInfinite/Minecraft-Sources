...
public class SPacketPlayerLook implements Packet<INetHandlerPlayClient> {
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      this.field_201065_e = (EntityAnchorArgument.Type)buf.readEnumValue(EntityAnchorArgument.Type.class);
      ...
      if (buf.readBoolean()) {
         ...
         this.field_201066_f = (EntityAnchorArgument.Type)buf.readEnumValue(EntityAnchorArgument.Type.class);
      }
