...
public class PotionBrewing {
   private static final List<PotionBrewing.MixPredicate<PotionType>> POTION_TYPE_CONVERSIONS = Lists.<PotionBrewing.MixPredicate<PotionType>>newArrayList();
   private static final List<PotionBrewing.MixPredicate<Item>> POTION_ITEM_CONVERSIONS = Lists.<PotionBrewing.MixPredicate<Item>>newArrayList();
   ...
   private static void func_196207_a(Item p_196207_0_, Item p_196207_1_, Item p_196207_2_) {
      if (!(p_196207_0_ instanceof ItemPotion)) {
         ...
         POTION_ITEM_CONVERSIONS.add(new PotionBrewing.MixPredicate<Item>(p_196207_0_, Ingredient.fromItems(p_196207_1_), p_196207_2_));
      }
   }
   ...
   private static void addMix(PotionType p_193357_0_, Item p_193357_1_, PotionType p_193357_2_) {
      POTION_TYPE_CONVERSIONS.add(new PotionBrewing.MixPredicate<PotionType>(p_193357_0_, Ingredient.fromItems(p_193357_1_), p_193357_2_));
   }
