...
public enum PackCompatibility {
   ...
   private PackCompatibility(String p_i47910_3_) {
      this.field_198975_d = new TextComponentTranslation("resourcePack.incompatible." + p_i47910_3_, new Object[0]);
      this.field_198976_e = new TextComponentTranslation("resourcePack.incompatible.confirm." + p_i47910_3_, new Object[0]);
   }
