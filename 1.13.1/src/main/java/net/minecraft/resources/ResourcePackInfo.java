...
public class ResourcePackInfo {
   ...
   private static final PackMetadataSection field_212500_b = new PackMetadataSection((new TextComponentTranslation("resourcePack.broken_assets", new Object[0])).applyTextStyles(new TextFormatting[]{TextFormatting.RED, TextFormatting.ITALIC}), 4);
   ...
   @Nullable
   public static <T extends ResourcePackInfo> T func_195793_a(String nameIn, boolean p_195793_1_, Supplier<IResourcePack> p_195793_2_, ResourcePackInfo.IFactory<T> factory, ResourcePackInfo.Priority p_195793_4_) {
