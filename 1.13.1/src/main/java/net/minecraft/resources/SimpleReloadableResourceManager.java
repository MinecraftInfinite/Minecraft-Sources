...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
   ...
   private final Map<String, FallbackResourceManager> namespaceResourceManagers = Maps.<String, FallbackResourceManager>newHashMap();
   private final List<IResourceManagerReloadListener> reloadListeners = Lists.<IResourceManagerReloadListener>newArrayList();
   private final Set<String> resourceNamespaces = Sets.<String>newLinkedHashSet();
