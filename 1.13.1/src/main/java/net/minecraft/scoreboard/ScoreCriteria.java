...
public class ScoreCriteria {
   public static final Map<String, ScoreCriteria> INSTANCES = Maps.<String, ScoreCriteria>newHashMap();
   ...
   public static ScoreCriteria byName(String p_197911_0_) {
      if (INSTANCES.containsKey(p_197911_0_)) {
         ...
         if (i < 0) {
            ...
            StatType<?> stattype = IRegistry.STATS.get(ResourceLocation.of(p_197911_0_.substring(0, i), '.'));
   ...
   public static enum RenderType {
      ...
      static {
         Builder<String, ScoreCriteria.RenderType> builder = ImmutableMap.<String, ScoreCriteria.RenderType>builder();
