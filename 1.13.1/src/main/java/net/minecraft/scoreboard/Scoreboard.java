...
public class Scoreboard {
   ...
   private final Map<ScoreCriteria, List<ScoreObjective>> scoreObjectiveCriterias = Maps.<ScoreCriteria, List<ScoreObjective>>newHashMap();
   ...
   public final void forAllObjectives(ScoreCriteria p_197893_1_, String p_197893_2_, Consumer<Score> p_197893_3_) {
      (this.scoreObjectiveCriterias.getOrDefault(p_197893_1_, Collections.<ScoreObjective>emptyList())).forEach((p_197906_3_) -> {
