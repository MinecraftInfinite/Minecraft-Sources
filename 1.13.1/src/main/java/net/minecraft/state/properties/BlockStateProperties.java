...
public class BlockStateProperties {
   ...
   public static final EnumProperty<EnumFacing.Axis> HORIZONTAL_AXIS = EnumProperty.<EnumFacing.Axis>create("axis", EnumFacing.Axis.class, EnumFacing.Axis.X, EnumFacing.Axis.Z);
   ...
   public static final EnumProperty<RedstoneSide> REDSTONE_EAST = EnumProperty.<RedstoneSide>create("east", RedstoneSide.class);
   public static final EnumProperty<RedstoneSide> REDSTONE_NORTH = EnumProperty.<RedstoneSide>create("north", RedstoneSide.class);
   public static final EnumProperty<RedstoneSide> REDSTONE_SOUTH = EnumProperty.<RedstoneSide>create("south", RedstoneSide.class);
   public static final EnumProperty<RedstoneSide> REDSTONE_WEST = EnumProperty.<RedstoneSide>create("west", RedstoneSide.class);
   ...
   public static final EnumProperty<RailShape> RAIL_SHAPE_STRAIGHT = EnumProperty.<RailShape>create("shape", RailShape.class, (p_210409_0_) -> {
   ...
   public static final EnumProperty<StructureMode> STRUCTURE_BLOCK_MODE = EnumProperty.<StructureMode>create("mode", StructureMode.class);
}
