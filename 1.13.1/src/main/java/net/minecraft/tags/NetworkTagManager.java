...
public class NetworkTagManager implements IResourceManagerReloadListener {
   private final NetworkTagCollection<Block> blocks = new NetworkTagCollection<Block>(IRegistry.BLOCK, "tags/blocks", "block");
   private final NetworkTagCollection<Item> items = new NetworkTagCollection<Item>(IRegistry.ITEM, "tags/items", "item");
   private final NetworkTagCollection<Fluid> fluids = new NetworkTagCollection<Fluid>(IRegistry.FLUID, "tags/fluids", "fluid");
