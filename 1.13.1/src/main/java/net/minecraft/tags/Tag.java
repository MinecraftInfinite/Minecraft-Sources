...
public class Tag<T> {
   ...
   public Tag(ResourceLocation resourceLocationIn) {
      ...
      this.taggedItems = Collections.<T>emptySet();
      this.entries = Collections.<Tag.ITagEntry<T>>emptyList();
   }
   ...
   public static class Builder<T> {
      private final Set<Tag.ITagEntry<T>> entries = Sets.<Tag.ITagEntry<T>>newLinkedHashSet();
      ...
      public Tag.Builder<T> add(T itemIn) {
         this.entries.add(new Tag.ListEntry<T>(Collections.singleton(itemIn)));
         return this;
      }

      @SafeVarargs
      public final Tag.Builder<T> add(T... itemsIn) {
         this.entries.add(new Tag.ListEntry<T>(Lists.newArrayList(itemsIn)));
         return this;
      }

      public Tag.Builder<T> addAll(Collection<T> itemsIn) {
         this.entries.add(new Tag.ListEntry<T>(itemsIn));
         return this;
      }

      public Tag.Builder<T> add(ResourceLocation resourceLocationIn) {
         this.entries.add(new Tag.TagEntry<T>(resourceLocationIn));
         return this;
      }

      public Tag.Builder<T> add(Tag<T> tagIn) {
         this.entries.add(new Tag.TagEntry<T>(tagIn));
         return this;
      }
      ...
      public Tag<T> build(ResourceLocation resourceLocationIn) {
         return new Tag<T>(resourceLocationIn, this.entries, this.preserveOrder);
      }
