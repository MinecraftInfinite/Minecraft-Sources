...
public class TileEntityBeacon extends TileEntityLockable implements ISidedInventory, ITickable {
   ...
   private static final Set<Potion> VALID_EFFECTS = (Set)Arrays.stream(EFFECTS_LIST).<Potion>flatMap(Arrays::stream).collect(Collectors.toSet());
   ...
   public ITextComponent getName() {
      return (ITextComponent)(this.customName != null ? this.customName : new TextComponentTranslation("container.beacon", new Object[0]));
   }
