...
public class TileEntityBrewingStand extends TileEntityLockable implements ISidedInventory, ITickable {
   ...
   public ITextComponent getName() {
      return (ITextComponent)(this.customName != null ? this.customName : new TextComponentTranslation("container.brewing", new Object[0]));
   }
      ...
      if (!this.world.isRemote) {
         ...
         if (!Arrays.equals(aboolean, this.filledSlots)) {
            ...
            for(int i = 0; i < BlockBrewingStand.HAS_BOTTLE.length; ++i) {
               iblockstate = (IBlockState)iblockstate.with(BlockBrewingStand.HAS_BOTTLE[i], Boolean.valueOf(aboolean[i]));
            }
