...
public class TileEntityConduit extends TileEntity implements ITickable {
   ...
   public TileEntityConduit(TileEntityType<?> p_i48929_1_) {
      super(p_i48929_1_);
      this.prismarinePositions = Lists.<BlockPos>newArrayList();
   }
   ...
   private void attackMobs() {
      ...
      if (i < 42) {
         ...
         List<EntityLivingBase> list = this.world.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, this.getAreaOfEffect(), (p_205033_0_) -> {
   ...
   private EntityLivingBase findExistingTarget() {
      List<EntityLivingBase> list = this.world.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, this.getAreaOfEffect(), (p_205032_1_) -> {
         return p_205032_1_.getUniqueID().equals(this.targetUuid);
      });
      return list.size() == 1 ? (EntityLivingBase)list.get(0) : null;
   }
