...
public class TileEntityHopper extends TileEntityLockableLoot implements IHopper, ITickable {
   ...
   private boolean transferItemsOut() {
      ...
      if (iinventory == null) {
         ...
         EnumFacing enumfacing = ((EnumFacing)this.getBlockState().get(BlockHopper.FACING)).getOpposite();
   ...
   private IInventory getInventoryForHopperTransfer() {
      EnumFacing enumfacing = (EnumFacing)this.getBlockState().get(BlockHopper.FACING);
   ...
   public static List<EntityItem> getCaptureItems(IHopper p_200115_0_) {
      return (List)p_200115_0_.getCollectionArea().toBoundingBoxList().stream().<EntityItem>flatMap((p_200110_1_) -> {
