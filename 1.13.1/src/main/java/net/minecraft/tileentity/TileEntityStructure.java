...
public class TileEntityStructure extends TileEntity {
   ...
   private void updateBlockState() {
      if (this.world != null) {
         ...
         if (iblockstate.getBlock() == Blocks.STRUCTURE_BLOCK) {
            this.world.setBlockState(blockpos, (IBlockState)iblockstate.with(BlockStructure.MODE, this.mode), 2);
         }
   ...
   public void setMode(StructureMode modeIn) {
      ...
      if (iblockstate.getBlock() == Blocks.STRUCTURE_BLOCK) {
         this.world.setBlockState(this.getPos(), (IBlockState)iblockstate.with(BlockStructure.MODE, modeIn), 2);
      }
   ...
   private List<TileEntityStructure> filterRelatedCornerBlocks(List<TileEntityStructure> p_184415_1_) {
      ...
      return (List)p_184415_1_.stream().filter(predicate).collect(Collectors.toList());
   }
