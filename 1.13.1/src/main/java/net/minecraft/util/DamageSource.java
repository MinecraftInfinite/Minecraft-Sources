...
public class DamageSource {
   ...
   public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
      ...
      String s1 = s + ".player";
      return entitylivingbase != null ? new TextComponentTranslation(s1, new Object[]{entityLivingBaseIn.getDisplayName(), entitylivingbase.getDisplayName()}) : new TextComponentTranslation(s, new Object[]{entityLivingBaseIn.getDisplayName()});
   }
