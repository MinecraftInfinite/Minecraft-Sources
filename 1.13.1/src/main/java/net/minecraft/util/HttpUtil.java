...
public class HttpUtil {
   ...
   public static ListenableFuture<?> downloadResourcePack(File saveFile, String packUrl, Map<String, String> p_180192_2_, int maxSize, @Nullable IProgressUpdate p_180192_4_, Proxy p_180192_5_) {
      return DOWNLOADER_EXECUTOR.submit(() -> {
         ...
         if (p_180192_4_ != null) {
            p_180192_4_.resetProgressAndMessage(new TextComponentTranslation("resourcepack.downloading", new Object[0]));
            p_180192_4_.displayLoadingString(new TextComponentTranslation("resourcepack.requesting", new Object[0]));
         }
         ...
         try {
            try {
               ...
               if (p_180192_4_ != null) {
                  p_180192_4_.displayLoadingString(new TextComponentTranslation("resourcepack.progress", new Object[]{String.format(Locale.ROOT, "%.2f", f1 / 1000.0F / 1000.0F)}));
               }
