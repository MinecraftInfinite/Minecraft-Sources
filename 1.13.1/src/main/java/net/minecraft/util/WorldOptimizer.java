...
public class WorldOptimizer {
   ...
   private final Object2FloatMap<DimensionType> field_212544_m = Object2FloatMaps.<DimensionType>synchronize(new Object2FloatOpenCustomHashMap(Util.identityHashStrategy()));
   ...
   private void optimize() {
      ...
      Builder<DimensionType, AnvilChunkLoader> builder = ImmutableMap.<DimensionType, AnvilChunkLoader>builder();
      ...
      this.totalChunks = 0;
      Builder<DimensionType, ListIterator<ChunkPos>> builder1 = ImmutableMap.<DimensionType, ListIterator<ChunkPos>>builder();
      ...
      for(Entry<DimensionType, AnvilChunkLoader> entry : map.entrySet()) {
         ((AnvilChunkLoader)entry.getValue()).func_212429_a(entry.getKey(), this.field_212222_d);
      }
