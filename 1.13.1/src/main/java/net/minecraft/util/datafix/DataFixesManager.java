...
public class DataFixesManager {
   ...
   private static DataFixer createFixer() {
      ExecutorService executorservice = Executors.newCachedThreadPool((new ThreadFactoryBuilder()).setUncaughtExceptionHandler((p_207102_0_, p_207102_1_) -> {
         LOGGER.error("Unable to build datafixers", p_207102_1_);
