...
public class BookPagesStrictJSON extends DataFix {
   ...
   public Dynamic<?> fixTag(Dynamic<?> p_209633_1_) {
      return (Dynamic)DataFixUtils.orElse(p_209633_1_.get("pages").flatMap(Dynamic::getStream).map((p_209630_0_) -> {
         return p_209630_0_.map((p_209631_0_) -> {
            if (!p_209631_0_.getStringValue().isPresent()) {
               return p_209631_0_;
            } else {
               String s = (String)p_209631_0_.getStringValue().get();
      ...
      }).map(p_209633_1_::createList), p_209633_1_);
   }
