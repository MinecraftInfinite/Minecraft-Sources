...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   ...
   private Dynamic<?> fixTag(Dynamic<?> p_209729_1_, Dynamic<?> p_209729_2_) {
      ...
      if (field_207912_a.containsKey(s)) {
         ...
         if (((String)pair.getFirst()).equals(p_209729_2_.getString("id"))) {
            String s1 = p_209729_2_.getString("Template");
            p_209729_2_ = p_209729_2_.set("Template", p_209729_2_.createString((String)(pair.getSecond()).getOrDefault(s1, s1)));
         }
      }
