...
public class CustomNameStringToComponentItem extends DataFix {
   ...
   private Dynamic<?> fixTag(Dynamic<?> p_209621_1_) {
      ...
      if (optional.isPresent()) {
         ...
         Optional<String> optional1 = dynamic.get("Name").<String>flatMap(Dynamic::getStringValue);
         if (optional1.isPresent()) {
            dynamic = dynamic.set("Name", dynamic.createString(ITextComponent.Serializer.toJson(new TextComponentString(optional1.get()))));
         } else {
            Optional<String> optional2 = dynamic.get("LocName").<String>flatMap(Dynamic::getStringValue);
            if (optional2.isPresent()) {
               dynamic = dynamic.set("Name", dynamic.createString(ITextComponent.Serializer.toJson(new TextComponentTranslation(optional2.get(), new Object[0]))));
