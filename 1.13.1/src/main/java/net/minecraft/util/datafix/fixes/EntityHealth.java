...
public class EntityHealth extends DataFix {
   ...
   public Dynamic<?> fixTag(Dynamic<?> p_209743_1_) {
      Optional<Number> optional = p_209743_1_.get("HealF").<Number>flatMap(Dynamic::getNumberValue);
      Optional<Number> optional1 = p_209743_1_.get("Health").<Number>flatMap(Dynamic::getNumberValue);
      float f;
