...
public abstract class EntityRenameHelper extends EntityRename {
   ...
   protected Pair<String, Typed<?>> fix(String p_209149_1_, Typed<?> p_209149_2_) {
      Pair<String, Dynamic<?>> pair = this.getNewNameAndTag(p_209149_1_, (Dynamic)p_209149_2_.getOrCreate(DSL.remainderFinder()));
      return Pair.<String, Typed<?>>of(pair.getFirst(), p_209149_2_.set(DSL.remainderFinder(), pair.getSecond()));
   }
