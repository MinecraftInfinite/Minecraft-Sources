...
public class ItemSpawnEggSplit extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<String> opticfinder1 = DSL.<String>fieldFinder("id", DSL.namespacedString());
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", type, (p_206361_4_) -> {
         Optional<Pair<String, String>> optional = p_206361_4_.<Pair<String, String>>getOptional(opticfinder);
         if (optional.isPresent() && Objects.equals((optional.get()).getSecond(), "minecraft:spawn_egg")) {
            ...
            Optional<String> optional1 = typed1.<String>getOptional(opticfinder1);
