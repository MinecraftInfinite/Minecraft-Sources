         ...
         return p_207423_0_.update(DSL.remainderFinder(), (p_207424_0_) -> {
            return (Dynamic)p_207424_0_.getMapValues().map((p_209663_1_) -> {
               return p_207424_0_.createMap((Map)p_209663_1_.entrySet().stream().map((p_209661_0_) -> {
                  if (((String)((Dynamic)p_209661_0_.getKey()).getStringValue().orElse("")).startsWith("key_")) {
                     int i = Integer.parseInt((String)((Dynamic)p_209661_0_.getValue()).getStringValue().orElse(""));
                     if (i < 0) {
                        int j = i + 100;
                        String s1;
                        if (j == 0) {
                        ...
                        return Pair.of(p_209661_0_.getKey(), ((Dynamic)p_209661_0_.getValue()).createString(s1));
                     } else {
                        String s = field_199186_a.getOrDefault(i, "key.unknown");
                        return Pair.of(p_209661_0_.getKey(), ((Dynamic)p_209661_0_.getValue()).createString(s));
                     }
                  } else {
