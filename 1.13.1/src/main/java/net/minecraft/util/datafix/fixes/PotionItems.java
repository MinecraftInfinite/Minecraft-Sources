...
public class PotionItems extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> opticfinder = DSL.<Pair<String, String>>fieldFinder("id", DSL.named(TypeReferences.ITEM_NAME.typeName(), DSL.namespacedString()));
      OpticFinder<?> opticfinder1 = type.findField("tag");
      return this.fixTypeEverywhereTyped("ItemPotionFix", type, (p_206351_2_) -> {
         Optional<Pair<String, String>> optional = p_206351_2_.<Pair<String, String>>getOptional(opticfinder);
         if (optional.isPresent() && Objects.equals((optional.get()).getSecond(), "minecraft:potion")) {
            Dynamic<?> dynamic = (Dynamic)p_206351_2_.get(DSL.remainderFinder());
            ...
            if (optional1.isPresent()) {
               ...
               Optional<String> optional2 = dynamic1.get("Potion").<String>flatMap(Dynamic::getStringValue);
               if (!optional2.isPresent()) {
                  String s = POTION_IDS[short1 & 127];
                  Typed<?> typed1 = ((Typed)optional1.get()).set(DSL.remainderFinder(), dynamic1.set("Potion", dynamic1.createString(s == null ? "minecraft:water" : s)));
