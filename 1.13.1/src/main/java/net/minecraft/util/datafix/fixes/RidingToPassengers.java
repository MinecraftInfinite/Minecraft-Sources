...
public class RidingToPassengers extends DataFix {
   ...
   private <OldEntityTree, NewEntityTree, Entity> TypeRewriteRule cap(Schema p_206340_1_, Schema p_206340_2_, Type<OldEntityTree> p_206340_3_, Type<NewEntityTree> p_206340_4_, Type<Entity> p_206340_5_) {
      ...
      if (!Objects.equals(type2, type)) {
         ...
         OpticFinder<Pair<String, Pair<Either<OldEntityTree, Unit>, Entity>>> opticfinder = DSL.<Pair<String, Pair<Either<OldEntityTree, Unit>, Entity>>>typeFinder(type);
         OpticFinder<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>> opticfinder1 = DSL.<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>>typeFinder(type1);
         OpticFinder<NewEntityTree> opticfinder2 = DSL.<NewEntityTree>typeFinder(p_206340_4_);
         ...
         return TypeRewriteRule.seq(this.fixTypeEverywhere("EntityRidingToPassengerFix", type, type1, (p_209760_5_) -> {
            return (p_208042_6_) -> {
               Optional<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>> optional = Optional.<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>>empty();
               Pair<String, Pair<Either<OldEntityTree, Unit>, Entity>> pair = p_208042_6_;

               while(true) {
                  Either<List<NewEntityTree>, Unit> either = (Either)DataFixUtils.orElse(optional.map((p_208037_4_) -> {
                     ...
                     NewEntityTree newentitytree = (NewEntityTree)typed.set(opticfinder1, p_208037_4_).getOptional(opticfinder2).orElseThrow(() -> {
                  ...
                  optional = Optional.<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>>of(Pair.of(TypeReferences.ENTITY_TYPE.typeName(), Pair.of(either, (pair.getSecond()).getSecond())));
                  ...
                  pair = (Pair)(new Typed<OldEntityTree>(p_206340_3_, p_209760_5_, optional1.get())).getOptional(opticfinder).orElseThrow(() -> {
