...
public class SpawnEggNames extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<String> opticfinder1 = DSL.<String>fieldFinder("id", DSL.string());
      ...
      return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type, (p_206359_6_) -> {
         Optional<Pair<String, String>> optional = p_206359_6_.<Pair<String, String>>getOptional(opticfinder);
         if (optional.isPresent() && Objects.equals((optional.get()).getSecond(), "minecraft:spawn_egg")) {
            ...
            if (s != null && (!optional4.isPresent() || !Objects.equals(optional4.get(), s))) {
               ...
               Typed<?> typed4 = (Typed)(this.getOutputSchema().getTypeRaw(TypeReferences.ENTITY).readTyped(dynamic1).getSecond()).orElseThrow(() -> {
