...
public enum EnumDifficulty {
   ...
   private static final EnumDifficulty[] ID_MAPPING = (EnumDifficulty[])Arrays.stream(values()).sorted(Comparator.comparingInt(EnumDifficulty::getId)).toArray((p_199928_0_) -> {
   ...
   public ITextComponent getDisplayName() {
      return new TextComponentTranslation("options.difficulty." + this.translationKey, new Object[0]);
   }
