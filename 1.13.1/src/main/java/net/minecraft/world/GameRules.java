...
public class GameRules {
   private static final TreeMap<String, GameRules.ValueDefinition> DEFINITIONS = (TreeMap)Util.make(new TreeMap(), (p_209363_0_) -> {
   ...
   public GameRules() {
      for(Entry<String, GameRules.ValueDefinition> entry : DEFINITIONS.entrySet()) {
         this.rules.put(entry.getKey(), ((GameRules.ValueDefinition)entry.getValue()).createValue());
      }
   ...
   public static enum ValueType {
      ANY_VALUE(StringArgumentType::greedyString, (p_196224_0_, p_196224_1_) -> {
         return (String)p_196224_0_.getArgument(p_196224_1_, String.class);
      }),
      BOOLEAN_VALUE(BoolArgumentType::bool, (p_196227_0_, p_196227_1_) -> {
         return ((Boolean)p_196227_0_.getArgument(p_196227_1_, Boolean.class)).toString();
      }),
      NUMERICAL_VALUE(IntegerArgumentType::integer, (p_196226_0_, p_196226_1_) -> {
         return ((Integer)p_196226_0_.getArgument(p_196226_1_, Integer.class)).toString();
      });
      ...
      public void updateValue(CommandContext<CommandSource> context, String name, GameRules.Value value) {
         value.setValue(this.argumentGetter.apply(context, name), ((CommandSource)context.getSource()).getServer());
      }
   }
}
