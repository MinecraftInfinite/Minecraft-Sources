...
public interface IWorldReaderBase extends IBlockReader {
   ...
   default Stream<VoxelShape> func_212391_a(VoxelShape p_212391_1_, VoxelShape p_212391_2_, boolean p_212391_3_) {
      ...
      Stream<VoxelShape> stream = StreamSupport.stream(BlockPos.MutableBlockPos.getAllInBoxMutable(i, k, i1, j - 1, l - 1, j1 - 1).spliterator(), false).<VoxelShape>map((p_212390_12_) -> {
      ...
      return Stream.<VoxelShape>concat(stream, Stream.generate(() -> {
