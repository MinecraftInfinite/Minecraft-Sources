...
public class WorldServer extends World implements IThreadListener {
   ...
   private final ServerTickList<Block> pendingBlockTicks = new ServerTickList<Block>(this, (p_205341_0_) -> {
   ...
   private final ServerTickList<Fluid> pendingFluidTicks = new ServerTickList<Fluid>(this, (p_205774_0_) -> {
   ...
   public WorldServer func_212251_i__() {
      ...
      ScoreboardSaveData scoreboardsavedata = (ScoreboardSaveData)this.getSavedData(DimensionType.OVERWORLD, ScoreboardSaveData::new, "scoreboard");
   ...
   protected BlockPos adjustPosToNearbyEntity(BlockPos pos) {
      ...
      List<EntityLivingBase> list = this.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb, (p_210194_1_) -> {
   ...
   public void saveAllChunks(boolean all, @Nullable IProgressUpdate progressCallback) throws SessionLockException {
      ...
      if (chunkproviderserver.canSave()) {
         if (progressCallback != null) {
            progressCallback.displaySavingString(new TextComponentTranslation("menu.savingLevel", new Object[0]));
         }

         this.saveLevel();
         if (progressCallback != null) {
            progressCallback.displayLoadingString(new TextComponentTranslation("menu.savingChunks", new Object[0]));
         }
