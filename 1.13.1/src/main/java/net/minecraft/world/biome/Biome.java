...
public abstract class Biome {
   ...
   protected final Map<GenerationStage.Carving, List<WorldCarverWrapper<?>>> carvers = Maps.<GenerationStage.Carving, List<WorldCarverWrapper<?>>>newHashMap();
   protected final Map<GenerationStage.Decoration, List<CompositeFeature<?, ?>>> features = Maps.<GenerationStage.Decoration, List<CompositeFeature<?, ?>>>newHashMap();
   protected final List<CompositeFlowerFeature<?>> flowers = Lists.<CompositeFlowerFeature<?>>newArrayList();
   protected final Map<Structure<?>, IFeatureConfig> structures = Maps.<Structure<?>, IFeatureConfig>newHashMap();
   private final Map<EnumCreatureType, List<Biome.SpawnListEntry>> spawns = Maps.<EnumCreatureType, List<Biome.SpawnListEntry>>newHashMap();
   ...
   public static <C extends IFeatureConfig> WorldCarverWrapper<C> createWorldCarverWrapper(IWorldCarver<C> carver, C config) {
      return new WorldCarverWrapper<C>(carver, config);
   }
   ...
   public static <F extends IFeatureConfig, D extends IPlacementConfig> CompositeFeature<F, D> createCompositeFeature(Feature<F> featureIn, F config, BasePlacement<D> basePlacementIn, D placementConfig) {
      return new CompositeFeature<F, D>(featureIn, config, basePlacementIn, placementConfig);
   }
   ...
   public static <D extends IPlacementConfig> CompositeFlowerFeature<D> createCompositeFlowerFeature(AbstractFlowersFeature flowerFeature, BasePlacement<D> placement, D config) {
      return new CompositeFlowerFeature<D>(flowerFeature, placement, config);
   }
   ...
   protected Biome(Biome.BiomeBuilder biomeBuilder) {
      if (biomeBuilder.surfaceBuilder != null && biomeBuilder.precipitation != null && biomeBuilder.category != null && biomeBuilder.depth != null && biomeBuilder.scale != null && biomeBuilder.temperature != null && biomeBuilder.downfall != null && biomeBuilder.waterColor != null && biomeBuilder.waterFogColor != null) {
         ...
         for(GenerationStage.Decoration generationstage$decoration : GenerationStage.Decoration.values()) {
            this.features.put(generationstage$decoration, Lists.<CompositeFeature<?, ?>>newArrayList());
         }

         for(EnumCreatureType enumcreaturetype : EnumCreatureType.values()) {
            this.spawns.put(enumcreaturetype, Lists.<Biome.SpawnListEntry>newArrayList());
         }
