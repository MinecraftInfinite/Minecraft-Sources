...
public abstract class BiomeProvider implements ITickable {
   ...
   protected final Map<Structure<?>, Boolean> hasStructureCache = Maps.<Structure<?>, Boolean>newHashMap();
   protected final Set<IBlockState> topBlocksCache = Sets.<IBlockState>newHashSet();
