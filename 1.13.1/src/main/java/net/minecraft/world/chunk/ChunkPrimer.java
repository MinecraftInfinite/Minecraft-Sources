...
public class ChunkPrimer implements IChunk {
   ...
   public ChunkPrimer(ChunkPos p_i48700_1_, UpgradeData data) {
      ...
      this.entities = Lists.<NBTTagCompound>newArrayList();
      this.lightPositions = Lists.<BlockPos>newArrayList();
      this.packedPositions = new ShortList[16];
      this.structureStartMap = Maps.<String, StructureStart>newHashMap();
      this.structureReferenceMap = Maps.<String, LongSet>newHashMap();
      this.carvingMasks = Maps.<GenerationStage.Carving, BitSet>newHashMap();
      this.pos = p_i48700_1_;
      this.upgradeData = data;
      this.pendingBlockTicks = new ChunkPrimerTickList<Block>((p_205332_0_) -> {
         return p_205332_0_ == null || p_205332_0_.getDefaultState().isAir();
      }, IRegistry.BLOCK::getKey, IRegistry.BLOCK::getOrDefault, p_i48700_1_);
      this.pendingFluidTicks = new ChunkPrimerTickList<Fluid>((p_205766_0_) -> {
   ...
   public Map<String, StructureStart> getStructureStarts() {
      return Collections.<String, StructureStart>unmodifiableMap(this.structureStartMap);
   }
   ...
   public void addStructureReference(String strucutre, long reference) {
      ((LongSet)this.structureReferenceMap.computeIfAbsent(strucutre, (p_201628_0_) -> {
         return new LongOpenHashSet();
      })).add(reference);
      this.modified = true;
   }
   ...
   public Map<String, LongSet> getStructureReferences() {
      return Collections.<String, LongSet>unmodifiableMap(this.structureReferenceMap);
   }
   ...
   public Map<BlockPos, NBTTagCompound> getDeferredTileEntities() {
      return Collections.<BlockPos, NBTTagCompound>unmodifiableMap(this.deferredTileEntities);
   }
