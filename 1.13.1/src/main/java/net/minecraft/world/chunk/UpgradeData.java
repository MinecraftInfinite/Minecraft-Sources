...
public class UpgradeData {
   ...
   private static final Map<Block, UpgradeData.IBlockFixer> field_196997_d = new IdentityHashMap<Block, UpgradeData.IBlockFixer>();
   private static final Set<UpgradeData.IBlockFixer> FIXERS = Sets.<UpgradeData.IBlockFixer>newHashSet();

   private UpgradeData() {
      this.field_196995_b = EnumSet.<EnumDirection8>noneOf(EnumDirection8.class);
   ...
   static enum BlockFixers implements UpgradeData.IBlockFixer {
      ...
      CHEST(new Block[]{Blocks.CHEST, Blocks.TRAPPED_CHEST}) {
         public IBlockState func_196982_a(IBlockState p_196982_1_, EnumFacing p_196982_2_, IBlockState p_196982_3_, IWorld p_196982_4_, BlockPos p_196982_5_, BlockPos p_196982_6_) {
            if (p_196982_3_.getBlock() == p_196982_1_.getBlock() && p_196982_2_.getAxis().isHorizontal() && p_196982_1_.get(BlockChest.TYPE) == ChestType.SINGLE && p_196982_3_.get(BlockChest.TYPE) == ChestType.SINGLE) {
               EnumFacing enumfacing = (EnumFacing)p_196982_1_.get(BlockChest.FACING);
               if (p_196982_2_.getAxis() != enumfacing.getAxis() && enumfacing == p_196982_3_.get(BlockChest.FACING)) {
                  ...
                  p_196982_4_.setBlockState(p_196982_6_, (IBlockState)p_196982_3_.with(BlockChest.TYPE, chesttype.opposite()), 18);
                  ...
                  return (IBlockState)p_196982_1_.with(BlockChest.TYPE, chesttype);
               }
            }
      ...
      LEAVES(true, new Block[]{Blocks.ACACIA_LEAVES, Blocks.BIRCH_LEAVES, Blocks.DARK_OAK_LEAVES, Blocks.JUNGLE_LEAVES, Blocks.OAK_LEAVES, Blocks.SPRUCE_LEAVES}) {
         private final ThreadLocal<List<ObjectSet<BlockPos>>> field_208828_g = ThreadLocal.<List<ObjectSet<BlockPos>>>withInitial(() -> {
         ...
         public IBlockState func_196982_a(IBlockState p_196982_1_, EnumFacing p_196982_2_, IBlockState p_196982_3_, IWorld p_196982_4_, BlockPos p_196982_5_, BlockPos p_196982_6_) {
            ...
            if (p_196982_1_ != iblockstate) {
               ...
               if (list.isEmpty()) {
                  for(int j = 0; j < 7; ++j) {
                     list.add(new ObjectOpenHashSet<BlockPos>());
                  }
               }

               ((ObjectSet)list.get(i)).add(p_196982_5_.toImmutable());
            }
            ...
            for(int i = 2; i < list.size(); ++i) {
               ...
               for(BlockPos blockpos : objectset) {
                  ...
                  if (iblockstate.get(BlockStateProperties.DISTANCE_1_7) >= j) {
                     p_208826_1_.setBlockState(blockpos, (IBlockState)iblockstate.with(BlockStateProperties.DISTANCE_1_7, Integer.valueOf(j)), 18);
                     if (i != 7) {
         ...
         public IBlockState func_196982_a(IBlockState p_196982_1_, EnumFacing p_196982_2_, IBlockState p_196982_3_, IWorld p_196982_4_, BlockPos p_196982_5_, BlockPos p_196982_6_) {
            if (p_196982_1_.get(BlockStem.AGE) == 7) {
               ...
               if (p_196982_3_.getBlock() == blockstemgrown) {
                  return (IBlockState)blockstemgrown.getAttachedStem().getDefaultState().with(BlockHorizontal.HORIZONTAL_FACING, p_196982_2_);
               }
            }
