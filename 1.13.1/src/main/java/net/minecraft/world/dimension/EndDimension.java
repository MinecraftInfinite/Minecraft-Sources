...
public class EndDimension extends Dimension {
   ...
   public IChunkGenerator<?> createChunkGenerator() {
      ...
      return ChunkGeneratorType.FLOATING_ISLANDS.create(this.world, BiomeProviderType.THE_END.create(((EndBiomeProviderSettings)BiomeProviderType.THE_END.createSettings()).setSeed(this.world.getSeed())), endgensettings);
   }
