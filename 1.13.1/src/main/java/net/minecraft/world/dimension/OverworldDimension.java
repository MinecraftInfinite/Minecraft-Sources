...
public class OverworldDimension extends Dimension {
   ...
   public IChunkGenerator<? extends IChunkGenSettings> createChunkGenerator() {
      ...
      if (worldtype == WorldType.FLAT) {
         ...
         SingleBiomeProviderSettings singlebiomeprovidersettings = ((SingleBiomeProviderSettings)biomeprovidertype.createSettings()).setBiome(Biomes.PLAINS);
         ...
         OverworldBiomeProviderSettings overworldbiomeprovidersettings = ((OverworldBiomeProviderSettings)biomeprovidertype1.createSettings()).setWorldInfo(this.world.getWorldInfo()).setGeneratorSettings(overworldgensettings);
         ...
         if (jsonobject.has("biome_source") && jsonobject.getAsJsonObject("biome_source").has("type") && jsonobject.getAsJsonObject("biome_source").has("options")) {
            ...
            if (BiomeProviderType.FIXED.getKey().equals(resourcelocation)) {
               SingleBiomeProviderSettings singlebiomeprovidersettings2 = ((SingleBiomeProviderSettings)biomeprovidertype.createSettings()).setBiome(abiome[0]);
            ...
            if (BiomeProviderType.CHECKERBOARD.getKey().equals(resourcelocation)) {
               ...
               CheckerboardBiomeProviderSettings checkerboardbiomeprovidersettings = ((CheckerboardBiomeProviderSettings)biomeprovidertype2.createSettings()).func_206860_a(abiome).setSize(j);
            ...
            if (BiomeProviderType.VANILLA_LAYERED.getKey().equals(resourcelocation)) {
               OverworldBiomeProviderSettings overworldbiomeprovidersettings1 = ((OverworldBiomeProviderSettings)biomeprovidertype1.createSettings()).setGeneratorSettings(new OverworldGenSettings()).setWorldInfo(this.world.getWorldInfo());
               biomeprovider = biomeprovidertype1.create(overworldbiomeprovidersettings1);
            }
         }

         if (biomeprovider == null) {
            biomeprovider = biomeprovidertype.create(((SingleBiomeProviderSettings)biomeprovidertype.createSettings()).setBiome(Biomes.OCEAN));
         }
