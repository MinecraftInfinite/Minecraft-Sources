         ...
         if (flag || flag1) {
            ...
            if (j < aendcrystaltowerfeature$endspike.length) {
               ...
               if (flag) {
                  ...
                  endcrystaltowerfeature.place(worldIn, worldIn.getChunkProvider().getChunkGenerator(), new Random(), new BlockPos(endcrystaltowerfeature$endspike.getCenterX(), 45, endcrystaltowerfeature$endspike.getCenterZ()), IFeatureConfig.NO_FEATURE_CONFIG);
               }
            } else if (flag) {
