...
public abstract class AbstractChunkGenerator<C extends IChunkGenSettings> implements IChunkGenerator<C> {
   ...
   protected final Map<Structure<? extends IFeatureConfig>, Long2ObjectMap<StructureStart>> structureStartCache = Maps.<Structure<? extends IFeatureConfig>, Long2ObjectMap<StructureStart>>newHashMap();
   protected final Map<Structure<? extends IFeatureConfig>, Long2ObjectMap<LongSet>> structureReferenceCache = Maps.<Structure<? extends IFeatureConfig>, Long2ObjectMap<LongSet>>newHashMap();
