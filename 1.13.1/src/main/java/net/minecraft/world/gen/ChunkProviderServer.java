...
public class ChunkProviderServer implements IChunkProvider {
   ...
   public ChunkProviderServer(WorldServer worldIn, IChunkLoader chunkLoaderIn, IChunkGenerator<?> chunkGeneratorIn, IThreadListener threadListener) {
      ...
      this.taskManager = new TaskManager<ChunkPos, ChunkStatus, ChunkPrimer>(this.chunkScheduler);
   }
   ...
   public Chunk getChunk(int x, int z, boolean p_186025_3_, boolean p_186025_4_) {
      ...
      if (chunk != null) {
         ...
         try {
            ...
            return (Chunk)completablefuture.thenApply(this::convertToChunk).join();
   ...
   public IChunk getChunkOrPrimer(int x, int z, boolean p_201713_3_) {
      ...
      return ichunk != null ? ichunk : (IChunk)this.chunkScheduler.func_212537_b(new ChunkPos(x, z), p_201713_3_);
   }
