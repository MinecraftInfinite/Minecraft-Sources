...
public class FlatGenSettings extends ChunkGenSettings {
   ...
   private static final CompositeFeature<MineshaftConfig, NoPlacementConfig> field_202250_m = Biome.<MineshaftConfig, NoPlacementConfig>createCompositeFeature(Feature.MINESHAFT, new MineshaftConfig(0.004D, MineshaftStructure.Type.NORMAL), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<VillageConfig, NoPlacementConfig> field_202251_n = Biome.<VillageConfig, NoPlacementConfig>createCompositeFeature(Feature.VILLAGE, new VillageConfig(0, VillagePieces.Type.OAK), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<StrongholdConfig, NoPlacementConfig> field_202252_o = Biome.<StrongholdConfig, NoPlacementConfig>createCompositeFeature(Feature.STRONGHOLD, new StrongholdConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<SwampHutConfig, NoPlacementConfig> field_202253_p = Biome.<SwampHutConfig, NoPlacementConfig>createCompositeFeature(Feature.SWAMP_HUT, new SwampHutConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<DesertPyramidConfig, NoPlacementConfig> field_202254_q = Biome.<DesertPyramidConfig, NoPlacementConfig>createCompositeFeature(Feature.DESERT_PYRAMID, new DesertPyramidConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<JunglePyramidConfig, NoPlacementConfig> field_202255_r = Biome.<JunglePyramidConfig, NoPlacementConfig>createCompositeFeature(Feature.JUNGLE_PYRAMID, new JunglePyramidConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<IglooConfig, NoPlacementConfig> field_202256_s = Biome.<IglooConfig, NoPlacementConfig>createCompositeFeature(Feature.IGLOO, new IglooConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<ShipwreckConfig, NoPlacementConfig> field_204750_v = Biome.<ShipwreckConfig, NoPlacementConfig>createCompositeFeature(Feature.SHIPWRECK, new ShipwreckConfig(false), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<OceanMonumentConfig, NoPlacementConfig> field_202257_t = Biome.<OceanMonumentConfig, NoPlacementConfig>createCompositeFeature(Feature.OCEAN_MONUMENT, new OceanMonumentConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<LakesConfig, LakeChanceConfig> field_202258_u = Biome.<LakesConfig, LakeChanceConfig>createCompositeFeature(Feature.LAKES, new LakesConfig(Blocks.WATER), Biome.LAKE_WATER, new LakeChanceConfig(4));
   private static final CompositeFeature<LakesConfig, LakeChanceConfig> field_202259_v = Biome.<LakesConfig, LakeChanceConfig>createCompositeFeature(Feature.LAKES, new LakesConfig(Blocks.LAVA), Biome.LAVA_LAKE, new LakeChanceConfig(80));
   private static final CompositeFeature<EndCityConfig, NoPlacementConfig> field_202260_w = Biome.<EndCityConfig, NoPlacementConfig>createCompositeFeature(Feature.END_CITY, new EndCityConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<WoodlandMansionConfig, NoPlacementConfig> field_202261_x = Biome.<WoodlandMansionConfig, NoPlacementConfig>createCompositeFeature(Feature.WOODLAND_MANSION, new WoodlandMansionConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<FortressConfig, NoPlacementConfig> field_202262_y = Biome.<FortressConfig, NoPlacementConfig>createCompositeFeature(Feature.FORTRESS, new FortressConfig(), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final CompositeFeature<OceanRuinConfig, NoPlacementConfig> field_204028_A = Biome.<OceanRuinConfig, NoPlacementConfig>createCompositeFeature(Feature.OCEAN_RUIN, new OceanRuinConfig(OceanRuinStructure.Type.COLD, 0.3F, 0.1F), Biome.PASSTHROUGH, IPlacementConfig.NO_PLACEMENT_CONFIG);
   public static final Map<CompositeFeature<?, ?>, GenerationStage.Decoration> field_202248_k = (Map)Util.make(Maps.newHashMap(), (p_209406_0_) -> {
   ...
   public static final Map<String, CompositeFeature<?, ?>[]> field_202247_j = (Map)Util.make(Maps.newHashMap(), (p_209404_0_) -> {
   ...
   public static final Map<CompositeFeature<?, ?>, IFeatureConfig> field_202249_l = (Map)Util.make(Maps.newHashMap(), (p_209405_0_) -> {
   ...
   public <T> Dynamic<T> func_210834_a(DynamicOps<T> p_210834_1_) {
      T t = p_210834_1_.createList(this.flatLayers.stream().<T>map((p_210837_1_) -> {
         return p_210834_1_.createMap(ImmutableMap.<T, T>of(p_210834_1_.createString("height"), p_210834_1_.createInt(p_210837_1_.getLayerCount()), p_210834_1_.createString("block"), p_210834_1_.createString(IRegistry.BLOCK.getKey(p_210837_1_.getLayerMaterial().getBlock()).toString())));
      }));
      ...
      return new Dynamic<T>(p_210834_1_, p_210834_1_.createMap(ImmutableMap.<T, T>of(p_210834_1_.createString("layers"), t, p_210834_1_.createString("biome"), p_210834_1_.createString(IRegistry.BIOME.getKey(this.biomeToUse).toString()), p_210834_1_.createString("structures"), t1)));
   }
   ...
   public static FlatGenSettings createFlatGenerator(Dynamic<?> settings) {
      ...
      List<Pair<Integer, Block>> list = (List)(settings.get("layers").flatMap(Dynamic::getStream).orElse(Stream.empty())).<Pair<Integer, Block>>map((p_210838_0_) -> {
      ...
      if (list.stream().anyMatch((p_211743_0_) -> {
         ...
         List<FlatLayerInfo> list1 = (List)list.stream().<FlatLayerInfo>map((p_211740_0_) -> {
            return new FlatLayerInfo(p_211740_0_.getFirst(), (Block)p_211740_0_.getSecond());
         }).collect(Collectors.toList());
         if (list1.isEmpty()) {
            return getDefaultFlatGenerator();
         } else {
            ...
            settings.get("structures").flatMap(Dynamic::getMapValues).ifPresent((p_211738_1_) -> {
               p_211738_1_.keySet().forEach((p_211739_1_) -> {
                  p_211739_1_.getStringValue().map((p_211742_1_) -> {
                     return (Map)flatgensettings.getWorldFeatures().put(p_211742_1_, Maps.newHashMap());
                  });
               });
            });
   ...
   public static FlatGenSettings createFlatGeneratorFromString(String flatGeneratorSettings) {
      ...
      if (!iterator.hasNext()) {
         ...
         if (list.isEmpty()) {
            ...
            flatgensettings.updateLayers();
            Biome biome = iterator.hasNext() ? (Biome)IRegistry.BIOME.get(new ResourceLocation(iterator.next())) : null;
