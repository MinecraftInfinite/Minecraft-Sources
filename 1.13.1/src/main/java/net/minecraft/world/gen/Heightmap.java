...
public class Heightmap {
   ...
   public Heightmap(IChunk chunkIn, Heightmap.Type type) {
      this.blockMatcher = ReaderAwareMatchers.<IBlockState>not(ReaderAwareMatchers.or(type.func_202264_a()));
      this.chunk = chunkIn;
   }
   ...
   public static enum Type {
      WORLD_SURFACE_WG("WORLD_SURFACE_WG", Heightmap.Usage.WORLDGEN, new IBlockMatcherReaderAware[]{BlockMatcherReaderAware.forBlock(Blocks.AIR)}),
      OCEAN_FLOOR_WG("OCEAN_FLOOR_WG", Heightmap.Usage.WORLDGEN, new IBlockMatcherReaderAware[]{BlockMatcherReaderAware.forBlock(Blocks.AIR), LiquidBlockMatcher.getInstance()}),
      LIGHT_BLOCKING("LIGHT_BLOCKING", Heightmap.Usage.LIVE_WORLD, new IBlockMatcherReaderAware[]{BlockMatcherReaderAware.forBlock(Blocks.AIR), LightEmittingMatcher.getInstance()}),
      MOTION_BLOCKING("MOTION_BLOCKING", Heightmap.Usage.LIVE_WORLD, new IBlockMatcherReaderAware[]{BlockMatcherReaderAware.forBlock(Blocks.AIR), AllowsMovementAndSolidMatcher.getInstance()}),
      MOTION_BLOCKING_NO_LEAVES("MOTION_BLOCKING_NO_LEAVES", Heightmap.Usage.LIVE_WORLD, new IBlockMatcherReaderAware[]{BlockMatcherReaderAware.forBlock(Blocks.AIR), BlockTagMatcher.forTag(BlockTags.LEAVES), AllowsMovementAndSolidMatcher.getInstance()}),
      OCEAN_FLOOR("OCEAN_FLOOR", Heightmap.Usage.LIVE_WORLD, new IBlockMatcherReaderAware[]{BlockMatcherReaderAware.forBlock(Blocks.AIR), AllowsMovementMatcher.getInstance()}),
      WORLD_SURFACE("WORLD_SURFACE", Heightmap.Usage.LIVE_WORLD, new IBlockMatcherReaderAware[]{BlockMatcherReaderAware.forBlock(Blocks.AIR)});

      private final IBlockMatcherReaderAware<IBlockState>[] field_202265_e;
      private final String id;
      private final Heightmap.Usage usage;
      private static final Map<String, Heightmap.Type> field_203503_g = (Map)Util.make(Maps.newHashMap(), (p_207801_0_) -> {
