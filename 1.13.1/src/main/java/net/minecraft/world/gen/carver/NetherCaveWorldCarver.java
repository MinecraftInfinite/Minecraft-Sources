...
public class NetherCaveWorldCarver extends CaveWorldCarver {
   public NetherCaveWorldCarver() {
      this.terrainBlocks = ImmutableSet.<Block>of(Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK, Blocks.NETHERRACK);
      this.terrainFluids = ImmutableSet.<Fluid>of(Fluids.LAVA, Fluids.WATER);
   }
