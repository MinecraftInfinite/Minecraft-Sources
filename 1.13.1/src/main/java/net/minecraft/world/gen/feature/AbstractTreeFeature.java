...
public abstract class AbstractTreeFeature<T extends IFeatureConfig> extends Feature<T> {
   ...
   public final boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, T p_212245_5_) {
      ...
      for(int j = 0; j < 6; ++j) {
         list.add(Sets.<BlockPos>newHashSet());
      }
               ...
               for(EnumFacing enumfacing : EnumFacing.values()) {
                  ...
                  if (!set.contains(blockpos$pooledmutableblockpos)) {
                     ...
                     if (iblockstate.has(BlockStateProperties.DISTANCE_1_7)) {
                        ...
                        this.func_208521_b(p_212245_1_, blockpos$pooledmutableblockpos, (IBlockState)iblockstate.with(BlockStateProperties.DISTANCE_1_7, Integer.valueOf(1)));
                     }
                  }
               }
            }
               ...
               for(EnumFacing enumfacing1 : EnumFacing.values()) {
                  ...
                  if (!set1.contains(blockpos$pooledmutableblockpos) && !set2.contains(blockpos$pooledmutableblockpos)) {
                     ...
                     if (iblockstate1.has(BlockStateProperties.DISTANCE_1_7)) {
                        ...
                        if (k > l + 1) {
                           IBlockState iblockstate2 = (IBlockState)iblockstate1.with(BlockStateProperties.DISTANCE_1_7, Integer.valueOf(l + 1));
