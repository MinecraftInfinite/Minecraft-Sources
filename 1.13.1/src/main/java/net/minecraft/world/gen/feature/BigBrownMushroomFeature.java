   ...
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, NoFeatureConfig p_212245_5_) {
      ...
      if (j >= 1 && j + i + 1 < 256) {
         ...
         if (!Block.isDirt(block) && block != Blocks.GRASS_BLOCK && block != Blocks.MYCELIUM) {
            ...
            IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.BROWN_MUSHROOM_BLOCK.getDefaultState().with(BlockHugeMushroom.UP, Boolean.valueOf(true))).with(BlockHugeMushroom.DOWN, Boolean.valueOf(false));
            int k1 = 3;
               ...
               for(int i2 = -3; i2 <= 3; ++i2) {
                  ...
                  if (!flag3 || !flag4) {
                     ...
                     if (!p_212245_1_.getBlockState(blockpos$mutableblockpos).isOpaqueCube(p_212245_1_, blockpos$mutableblockpos)) {
                        ...
                        this.setBlockState(p_212245_1_, blockpos$mutableblockpos, (IBlockState)((IBlockState)((IBlockState)((IBlockState)iblockstate1.with(BlockHugeMushroom.WEST, Boolean.valueOf(flag5))).with(BlockHugeMushroom.EAST, Boolean.valueOf(flag6))).with(BlockHugeMushroom.NORTH, Boolean.valueOf(flag7))).with(BlockHugeMushroom.SOUTH, Boolean.valueOf(flag8)));
                     }
                  }
               }
            }

            IBlockState iblockstate2 = (IBlockState)((IBlockState)Blocks.MUSHROOM_STEM.getDefaultState().with(BlockHugeMushroom.UP, Boolean.valueOf(false))).with(BlockHugeMushroom.DOWN, Boolean.valueOf(false));
