...
public class BigTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   ...
   private int makeLimb(Set<BlockPos> p_208523_1_, IWorld p_208523_2_, BlockPos p_208523_3_, BlockPos p_208523_4_, boolean p_208523_5_) {
      if (!p_208523_5_ && Objects.equals(p_208523_3_, p_208523_4_)) {
         ...
         for(int j = 0; j <= i; ++j) {
            ...
            if (p_208523_5_) {
               this.func_208520_a(p_208523_1_, p_208523_2_, blockpos1, (IBlockState)LOG.with(BlockLog.AXIS, this.getLoxAxis(p_208523_3_, blockpos1)));
   ...
   public boolean place(Set<BlockPos> changedBlocks, IWorld worldIn, Random rand, BlockPos position) {
      ...
      if (i == -1) {
         ...
         int i1 = i - 5;
         List<BigTreeFeature.FoliageCoordinates> list = Lists.<BigTreeFeature.FoliageCoordinates>newArrayList();
