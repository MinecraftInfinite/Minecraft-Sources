...
public abstract class CoralFeature extends Feature<NoFeatureConfig> {
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, NoFeatureConfig p_212245_5_) {
      IBlockState iblockstate = ((Block)BlockTags.CORAL_BLOCKS.getRandomElement(p_212245_3_)).getDefaultState();
   ...
   protected boolean func_204624_b(IWorld p_204624_1_, Random p_204624_2_, BlockPos p_204624_3_, IBlockState p_204624_4_) {
      ...
      if ((iblockstate.getBlock() == Blocks.WATER || iblockstate.isIn(BlockTags.CORALS)) && p_204624_1_.getBlockState(blockpos).getBlock() == Blocks.WATER) {
         ...
         if (p_204624_2_.nextFloat() < 0.25F) {
            ...
            p_204624_1_.setBlockState(blockpos, (IBlockState)Blocks.SEA_PICKLE.getDefaultState().with(BlockSeaPickle.PICKLES, Integer.valueOf(p_204624_2_.nextInt(4) + 1)), 2);
         }
         ...
         for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
            if (p_204624_2_.nextFloat() < 0.2F) {
               ...
               if (p_204624_1_.getBlockState(blockpos1).getBlock() == Blocks.WATER) {
                  IBlockState iblockstate1 = (IBlockState)((Block)BlockTags.WALL_CORALS.getRandomElement(p_204624_2_)).getDefaultState().with(BlockCoralWallFanDead.FACING, enumfacing);
