               ...
               for(int l = -2; l <= 2; ++l) {
                  for(int i1 = 0; i1 <= 3; ++i1) {
                     ...
                     if (flag || flag1 || flag2) {
                        ...
                        IBlockState iblockstate = (IBlockState)((IBlockState)((IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(flag3 && l != -2))).with(BlockPane.SOUTH, Boolean.valueOf(flag3 && l != 2))).with(BlockPane.WEST, Boolean.valueOf(flag4 && k != -2))).with(BlockPane.EAST, Boolean.valueOf(flag4 && k != 2));
