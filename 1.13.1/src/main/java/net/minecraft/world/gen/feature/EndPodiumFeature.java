...
public class EndPodiumFeature extends Feature<NoFeatureConfig> {
   ...
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, NoFeatureConfig p_212245_5_) {
      ...
      for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
         this.setBlockState(p_212245_1_, blockpos.offset(enumfacing), (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, enumfacing));
      }
