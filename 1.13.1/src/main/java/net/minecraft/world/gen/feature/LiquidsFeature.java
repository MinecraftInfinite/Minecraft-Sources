...
public class LiquidsFeature extends Feature<LiquidsConfig> {
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, LiquidsConfig p_212245_5_) {
      if (!Block.isRock(p_212245_1_.getBlockState(p_212245_4_.up()).getBlock())) {
         ...
         if (!iblockstate.isAir() && !Block.isRock(iblockstate.getBlock())) {
            ...
            if (j == 3 && k == 1) {
               p_212245_1_.setBlockState(p_212245_4_, p_212245_5_.fluid.getDefaultState().getBlockState(), 2);
               p_212245_1_.getPendingFluidTicks().scheduleTick(p_212245_4_, p_212245_5_.fluid, 0);
               ++i;
            }
