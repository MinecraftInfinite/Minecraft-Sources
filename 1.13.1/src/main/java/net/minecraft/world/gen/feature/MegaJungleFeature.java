...
public class MegaJungleFeature extends HugeTreesFeature<NoFeatureConfig> {
      ...
      if (!this.func_203427_a(worldIn, position, i)) {
         ...
         for(int j = position.getY() + i - 2 - rand.nextInt(4); j > position.getY() + i / 2; j -= 2 + rand.nextInt(4)) {
            ...
            for(int i1 = 0; i1 < 5; ++i1) {
               ...
               this.func_208520_a(changedBlocks, worldIn, new BlockPos(k, j - 3 + i1 / 2, l), this.trunk);
            }
         ...
         for(int i2 = 0; i2 < i; ++i2) {
            ...
            if (this.canGrowInto(worldIn.getBlockState(blockpos).getBlock())) {
               this.func_208520_a(changedBlocks, worldIn, blockpos, this.trunk);
               if (i2 > 0) {
            ...
            if (i2 < i - 1) {
               ...
               if (this.canGrowInto(worldIn.getBlockState(blockpos1).getBlock())) {
                  this.func_208520_a(changedBlocks, worldIn, blockpos1, this.trunk);
                  if (i2 > 0) {
               ...
               if (this.canGrowInto(worldIn.getBlockState(blockpos2).getBlock())) {
                  this.func_208520_a(changedBlocks, worldIn, blockpos2, this.trunk);
                  if (i2 > 0) {
               ...
               if (this.canGrowInto(worldIn.getBlockState(blockpos3).getBlock())) {
                  this.func_208520_a(changedBlocks, worldIn, blockpos3, this.trunk);
                  if (i2 > 0) {
   ...
   private void func_202407_a(IWorld p_202407_1_, Random p_202407_2_, BlockPos p_202407_3_, BooleanProperty p_202407_4_) {
      if (p_202407_2_.nextInt(3) > 0 && p_202407_1_.isAirBlock(p_202407_3_)) {
         this.setBlockState(p_202407_1_, p_202407_3_, (IBlockState)Blocks.VINE.getDefaultState().with(p_202407_4_, Boolean.valueOf(true)));
      }
