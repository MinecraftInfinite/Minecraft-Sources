...
public class SphereReplaceFeature extends Feature<SphereReplaceConfig> {
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, SphereReplaceConfig p_212245_5_) {
            ...
            for(int l = p_212245_4_.getZ() - j; l <= p_212245_4_.getZ() + j; ++l) {
               ...
               if (i1 * i1 + j1 * j1 <= j * j) {
                  for(int k1 = p_212245_4_.getY() - p_212245_5_.ySize; k1 <= p_212245_4_.getY() + p_212245_5_.ySize; ++k1) {
                     ...
                     if (p_212245_5_.targets.contains(block)) {
