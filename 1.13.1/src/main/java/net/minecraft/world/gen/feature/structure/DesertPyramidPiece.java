...
public class DesertPyramidPiece extends ScatteredStructurePiece {
   ...
   public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
      ...
      IBlockState iblockstate1 = (IBlockState)Blocks.SANDSTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH);
      IBlockState iblockstate2 = (IBlockState)Blocks.SANDSTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH);
      IBlockState iblockstate3 = (IBlockState)Blocks.SANDSTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.EAST);
      IBlockState iblockstate = (IBlockState)Blocks.SANDSTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.WEST);
