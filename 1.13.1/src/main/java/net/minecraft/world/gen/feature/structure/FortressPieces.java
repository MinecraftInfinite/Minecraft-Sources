...
public class FortressPieces {
   ...
   public static class Corridor extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true));
         IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
   ...
   public static class Corridor3 extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         IBlockState iblockstate = (IBlockState)Blocks.NETHER_BRICK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH);
         IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
   ...
   public static class Corridor4 extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         IBlockState iblockstate = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
         IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true));
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.EAST, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true)), 0, 3, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true)), 8, 3, 8, structureBoundingBoxIn);
   ...
   public static class Entrance extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true)), 0, 13, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.SOUTH, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true)), 0, 13, 12, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.SOUTH, Boolean.valueOf(true))).with(BlockFence.WEST, Boolean.valueOf(true)), 12, 13, 12, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.WEST, Boolean.valueOf(true)), 12, 13, 0, structureBoundingBoxIn);

         for(int k = 3; k <= 9; k += 2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, k, 1, 8, k, (IBlockState)iblockstate1.with(BlockFence.WEST, Boolean.valueOf(true)), (IBlockState)iblockstate1.with(BlockFence.WEST, Boolean.valueOf(true)), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 7, k, 11, 8, k, (IBlockState)iblockstate1.with(BlockFence.EAST, Boolean.valueOf(true)), (IBlockState)iblockstate1.with(BlockFence.EAST, Boolean.valueOf(true)), false);
         }
   ...
   public static class NetherStalkRoom extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true));
         IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
         IBlockState iblockstate2 = (IBlockState)iblockstate1.with(BlockFence.WEST, Boolean.valueOf(true));
         IBlockState iblockstate3 = (IBlockState)iblockstate1.with(BlockFence.EAST, Boolean.valueOf(true));
         ...
         IBlockState iblockstate4 = (IBlockState)Blocks.NETHER_BRICK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH);
         ...
         IBlockState iblockstate5 = (IBlockState)iblockstate4.with(BlockStairs.FACING, EnumFacing.EAST);
         IBlockState iblockstate6 = (IBlockState)iblockstate4.with(BlockStairs.FACING, EnumFacing.WEST);
   ...
   public static class Start extends FortressPieces.Crossing3 {
      ...
      public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_) {
         ...
         this.primaryWeights = Lists.<FortressPieces.PieceWeight>newArrayList();
         ...
         this.secondaryWeights = Lists.<FortressPieces.PieceWeight>newArrayList();
   ...
   public static class Straight extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
         IBlockState iblockstate2 = (IBlockState)iblockstate1.with(BlockFence.EAST, Boolean.valueOf(true));
         IBlockState iblockstate = (IBlockState)iblockstate1.with(BlockFence.WEST, Boolean.valueOf(true));
   ...
   public static class Throne extends FortressPieces.Piece {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true));
         IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
         this.setBlockState(worldIn, (IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true)), 1, 6, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.EAST, Boolean.valueOf(true)), 5, 6, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.EAST, Boolean.valueOf(true))).with(BlockFence.NORTH, Boolean.valueOf(true)), 0, 6, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.NORTH, Boolean.valueOf(true)), 6, 6, 3, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.EAST, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true)), 0, 6, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true)), 6, 6, 8, structureBoundingBoxIn);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 6, 8, 5, 6, 8, iblockstate, iblockstate, false);
         this.setBlockState(worldIn, (IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.EAST, Boolean.valueOf(true)), 1, 7, 8, structureBoundingBoxIn);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 7, 8, 4, 7, 8, iblockstate, iblockstate, false);
         this.setBlockState(worldIn, (IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true)), 5, 7, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.EAST, Boolean.valueOf(true)), 2, 8, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, iblockstate, 3, 8, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.NETHER_BRICK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true)), 4, 8, 8, structureBoundingBoxIn);
         if (!this.hasSpawner) {
