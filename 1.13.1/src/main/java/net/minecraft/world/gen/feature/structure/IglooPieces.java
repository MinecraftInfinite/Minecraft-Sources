...
public class IglooPieces {
   ...
   private static final Map<ResourceLocation, BlockPos> field_207621_d = ImmutableMap.<ResourceLocation, BlockPos>of(field_202592_e, new BlockPos(3, 5, 5), field_202593_f, new BlockPos(1, 3, 1), field_202594_g, new BlockPos(3, 6, 7));
   private static final Map<ResourceLocation, BlockPos> field_207622_e = ImmutableMap.<ResourceLocation, BlockPos>of(field_202592_e, new BlockPos(0, 0, 0), field_202593_f, new BlockPos(2, -3, 4), field_202594_g, new BlockPos(0, -3, -2));
