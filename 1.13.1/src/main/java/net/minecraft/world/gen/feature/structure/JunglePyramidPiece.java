...
public class JunglePyramidPiece extends ScatteredStructurePiece {
   ...
   public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
      if (!this.func_202580_a(worldIn, structureBoundingBoxIn, 0)) {
         ...
         IBlockState iblockstate3 = (IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.EAST);
         IBlockState iblockstate4 = (IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.WEST);
         IBlockState iblockstate = (IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH);
         IBlockState iblockstate1 = (IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH);
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.TRIPWIRE_HOOK.getDefaultState().with(BlockTripWireHook.FACING, EnumFacing.EAST)).with(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 1, -3, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.TRIPWIRE_HOOK.getDefaultState().with(BlockTripWireHook.FACING, EnumFacing.WEST)).with(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 4, -3, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)((IBlockState)Blocks.TRIPWIRE.getDefaultState().with(BlockTripWire.EAST, Boolean.valueOf(true))).with(BlockTripWire.WEST, Boolean.valueOf(true))).with(BlockTripWire.ATTACHED, Boolean.valueOf(true)), 2, -3, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)((IBlockState)Blocks.TRIPWIRE.getDefaultState().with(BlockTripWire.EAST, Boolean.valueOf(true))).with(BlockTripWire.WEST, Boolean.valueOf(true))).with(BlockTripWire.ATTACHED, Boolean.valueOf(true)), 3, -3, 8, structureBoundingBoxIn);
         IBlockState iblockstate5 = (IBlockState)((IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.NORTH, RedstoneSide.SIDE)).with(BlockRedstoneWire.SOUTH, RedstoneSide.SIDE);
         this.setBlockState(worldIn, (IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.SOUTH, RedstoneSide.SIDE), 5, -3, 7, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.NORTH, RedstoneSide.SIDE)).with(BlockRedstoneWire.WEST, RedstoneSide.SIDE), 5, -3, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.EAST, RedstoneSide.SIDE), 4, -3, 1, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, (IBlockState)Blocks.VINE.getDefaultState().with(BlockVine.SOUTH, Boolean.valueOf(true)), 3, -2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.TRIPWIRE_HOOK.getDefaultState().with(BlockTripWireHook.FACING, EnumFacing.NORTH)).with(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.TRIPWIRE_HOOK.getDefaultState().with(BlockTripWireHook.FACING, EnumFacing.SOUTH)).with(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)((IBlockState)Blocks.TRIPWIRE.getDefaultState().with(BlockTripWire.NORTH, Boolean.valueOf(true))).with(BlockTripWire.SOUTH, Boolean.valueOf(true))).with(BlockTripWire.ATTACHED, Boolean.valueOf(true)), 7, -3, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)((IBlockState)Blocks.TRIPWIRE.getDefaultState().with(BlockTripWire.NORTH, Boolean.valueOf(true))).with(BlockTripWire.SOUTH, Boolean.valueOf(true))).with(BlockTripWire.ATTACHED, Boolean.valueOf(true)), 7, -3, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)((IBlockState)Blocks.TRIPWIRE.getDefaultState().with(BlockTripWire.NORTH, Boolean.valueOf(true))).with(BlockTripWire.SOUTH, Boolean.valueOf(true))).with(BlockTripWire.ATTACHED, Boolean.valueOf(true)), 7, -3, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.EAST, RedstoneSide.SIDE), 8, -3, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.WEST, RedstoneSide.SIDE)).with(BlockRedstoneWire.SOUTH, RedstoneSide.SIDE), 9, -3, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.NORTH, RedstoneSide.SIDE)).with(BlockRedstoneWire.SOUTH, RedstoneSide.UP), 9, -3, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.MOSSY_COBBLESTONE.getDefaultState(), 9, -3, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.NORTH, RedstoneSide.SIDE), 9, -2, 4, structureBoundingBoxIn);
         if (!this.placedTrap2) {
         ...
         this.setBlockState(worldIn, (IBlockState)Blocks.VINE.getDefaultState().with(BlockVine.EAST, Boolean.valueOf(true)), 8, -1, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.VINE.getDefaultState().with(BlockVine.EAST, Boolean.valueOf(true)), 8, -2, 3, structureBoundingBoxIn);
         ...
         IBlockState iblockstate2 = (IBlockState)((IBlockState)Blocks.LEVER.getDefaultState().with(BlockLever.HORIZONTAL_FACING, EnumFacing.NORTH)).with(BlockLever.FACE, AttachFace.WALL);
         ...
         this.setBlockState(worldIn, (IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.NORTH, RedstoneSide.SIDE), 8, -2, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.REDSTONE_WIRE.getDefaultState().with(BlockRedstoneWire.SOUTH, RedstoneSide.SIDE), 8, -2, 10, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.REDSTONE_WIRE.getDefaultState(), 10, -1, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.STICKY_PISTON.getDefaultState().with(BlockPistonBase.FACING, EnumFacing.UP), 9, -2, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.STICKY_PISTON.getDefaultState().with(BlockPistonBase.FACING, EnumFacing.WEST), 10, -2, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.STICKY_PISTON.getDefaultState().with(BlockPistonBase.FACING, EnumFacing.WEST), 10, -1, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.REPEATER.getDefaultState().with(BlockRedstoneRepeater.HORIZONTAL_FACING, EnumFacing.NORTH), 10, -2, 10, structureBoundingBoxIn);
