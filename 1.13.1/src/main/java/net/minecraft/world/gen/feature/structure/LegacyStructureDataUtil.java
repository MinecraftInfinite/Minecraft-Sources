...
public abstract class LegacyStructureDataUtil {
   ...
   private final Map<String, Long2ObjectMap<NBTTagCompound>> field_208223_e = Maps.<String, Long2ObjectMap<NBTTagCompound>>newHashMap();
   private final Map<String, StructureIndexesSavedData> field_208224_f = Maps.<String, StructureIndexesSavedData>newHashMap();
   ...
   private boolean func_208209_a(int p_208209_1_, int p_208209_2_) {
      if (!this.field_208222_d) {
         ...
         for(String s : this.func_208218_b()) {
            if (this.field_208223_e.get(s) != null && ((StructureIndexesSavedData)this.field_208224_f.get(field_208220_b.get(s))).func_208023_c(ChunkPos.asLong(p_208209_1_, p_208209_2_))) {
               return true;
            }
         }
   ...
   private NBTTagCompound func_212182_a(NBTTagCompound p_212182_1_, ChunkPos p_212182_2_) {
      ...
      for(String s : this.func_208218_b()) {
         ...
         if (long2objectmap != null) {
            ...
            if (((StructureIndexesSavedData)this.field_208224_f.get(field_208220_b.get(s))).func_208023_c(i)) {
   ...
   private void func_212184_a(@Nullable WorldSavedDataStorage p_212184_1_) {
      if (p_212184_1_ != null) {
         for(String s : this.func_208214_a()) {
            ...
            String s5 = s + "_index";
            StructureIndexesSavedData structureindexessaveddata = (StructureIndexesSavedData)p_212184_1_.get(DimensionType.OVERWORLD, StructureIndexesSavedData::new, s5);
