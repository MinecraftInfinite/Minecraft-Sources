...
public class OceanMonumentPieces {
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.Piece {
      ...
      private final List<OceanMonumentPieces.Piece> childPieces = Lists.<OceanMonumentPieces.Piece>newArrayList();
      ...
      public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
         ...
         List<OceanMonumentPieces.MonumentRoomFitHelper> list1 = Lists.<OceanMonumentPieces.MonumentRoomFitHelper>newArrayList();
