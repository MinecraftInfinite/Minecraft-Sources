...
public class StrongholdPieces {
   ...
   public static void prepareStructurePieces() {
      structurePieceList = Lists.<StrongholdPieces.PieceWeight>newArrayList();
   ...
   public static class Crossing extends StrongholdPieces.Stronghold {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 5, 7, 7, 5, 9, (IBlockState)Blocks.STONE_SLAB.getDefaultState().with(BlockSlab.TYPE, SlabType.DOUBLE), (IBlockState)Blocks.STONE_SLAB.getDefaultState().with(BlockSlab.TYPE, SlabType.DOUBLE), false);
         this.setBlockState(worldIn, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.SOUTH), 6, 5, 6, structureBoundingBoxIn);
         return true;
      }
   }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         for(int l = 1; l <= 13; ++l) {
            if ((l - 1) % 4 == 0) {
               ...
               this.setBlockState(worldIn, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.EAST), 2, 3, l, structureBoundingBoxIn);
               this.setBlockState(worldIn, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.WEST), 11, 3, l, structureBoundingBoxIn);
               if (this.isLargeRoom) {
         ...
         if (this.isLargeRoom) {
            ...
            IBlockState iblockstate5 = (IBlockState)((IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true));
            IBlockState iblockstate = (IBlockState)((IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
            ...
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true)), 3, 6, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.SOUTH, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true)), 3, 6, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.WEST, Boolean.valueOf(true)), 10, 6, 2, structureBoundingBoxIn);

            for(int i1 = 0; i1 <= 2; ++i1) {
               this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.SOUTH, Boolean.valueOf(true))).with(BlockFence.WEST, Boolean.valueOf(true)), 8 + i1, 6, 12 - i1, structureBoundingBoxIn);
               if (i1 != 2) {
                  this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true)), 8 + i1, 6, 11 - i1, structureBoundingBoxIn);
               }
            }
            ...
            int j1 = 7;
            int k1 = 7;
            IBlockState iblockstate1 = (IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.EAST, Boolean.valueOf(true));
            this.setBlockState(worldIn, iblockstate1, 6, 9, 7, structureBoundingBoxIn);
            IBlockState iblockstate2 = (IBlockState)Blocks.OAK_FENCE.getDefaultState().with(BlockFence.WEST, Boolean.valueOf(true));
            ...
            IBlockState iblockstate3 = (IBlockState)((IBlockState)iblockstate.with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true));
            ...
            this.setBlockState(worldIn, (IBlockState)iblockstate1.with(BlockFence.NORTH, Boolean.valueOf(true)), 6, 7, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)iblockstate1.with(BlockFence.SOUTH, Boolean.valueOf(true)), 6, 7, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)iblockstate2.with(BlockFence.NORTH, Boolean.valueOf(true)), 7, 7, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)iblockstate2.with(BlockFence.SOUTH, Boolean.valueOf(true)), 7, 7, 8, structureBoundingBoxIn);
   ...
   public static class PortalRoom extends StrongholdPieces.Stronghold {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate = (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true))).with(BlockPane.SOUTH, Boolean.valueOf(true));
         IBlockState iblockstate1 = (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.WEST, Boolean.valueOf(true))).with(BlockPane.EAST, Boolean.valueOf(true));
         ...
         IBlockState iblockstate5 = (IBlockState)Blocks.STONE_BRICK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH);
         ...
         IBlockState iblockstate6 = (IBlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(BlockEndPortalFrame.FACING, EnumFacing.NORTH);
         IBlockState iblockstate2 = (IBlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(BlockEndPortalFrame.FACING, EnumFacing.SOUTH);
         IBlockState iblockstate3 = (IBlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(BlockEndPortalFrame.FACING, EnumFacing.EAST);
         IBlockState iblockstate4 = (IBlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(BlockEndPortalFrame.FACING, EnumFacing.WEST);
         boolean flag = true;
         ...
         this.setBlockState(worldIn, (IBlockState)iblockstate6.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[0])), 4, 3, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate6.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[1])), 5, 3, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate6.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[2])), 6, 3, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate2.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[3])), 4, 3, 12, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate2.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[4])), 5, 3, 12, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate2.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[5])), 6, 3, 12, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate3.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[6])), 3, 3, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate3.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[7])), 3, 3, 10, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate3.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[8])), 3, 3, 11, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate4.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[9])), 7, 3, 9, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate4.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[10])), 7, 3, 10, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate4.with(BlockEndPortalFrame.EYE, Boolean.valueOf(aboolean[11])), 7, 3, 11, structureBoundingBoxIn);
         if (flag) {
   ...
   public static class Prison extends StrongholdPieces.Stronghold {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         for(int i = 1; i <= 3; ++i) {
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true))).with(BlockPane.SOUTH, Boolean.valueOf(true)), 4, i, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true))).with(BlockPane.SOUTH, Boolean.valueOf(true))).with(BlockPane.EAST, Boolean.valueOf(true)), 4, i, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true))).with(BlockPane.SOUTH, Boolean.valueOf(true)), 4, i, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.WEST, Boolean.valueOf(true))).with(BlockPane.EAST, Boolean.valueOf(true)), 5, i, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.WEST, Boolean.valueOf(true))).with(BlockPane.EAST, Boolean.valueOf(true)), 6, i, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.WEST, Boolean.valueOf(true))).with(BlockPane.EAST, Boolean.valueOf(true)), 7, i, 5, structureBoundingBoxIn);
         }

         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true))).with(BlockPane.SOUTH, Boolean.valueOf(true)), 4, 3, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true))).with(BlockPane.SOUTH, Boolean.valueOf(true)), 4, 3, 8, structureBoundingBoxIn);
         IBlockState iblockstate1 = (IBlockState)Blocks.IRON_DOOR.getDefaultState().with(BlockDoor.FACING, EnumFacing.WEST);
         IBlockState iblockstate = (IBlockState)((IBlockState)Blocks.IRON_DOOR.getDefaultState().with(BlockDoor.FACING, EnumFacing.WEST)).with(BlockDoor.HALF, DoubleBlockHalf.UPPER);
   ...
   public static class RoomCrossing extends StrongholdPieces.Stronghold {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         case 0:
            ...
            this.setBlockState(worldIn, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.WEST), 4, 3, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.EAST), 6, 3, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.SOUTH), 5, 3, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.NORTH), 5, 3, 6, structureBoundingBoxIn);
   ...
   public static class StairsStraight extends StrongholdPieces.Stronghold {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate = (IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH);
   ...
   public static class Straight extends StrongholdPieces.Stronghold {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
         this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 6);
         IBlockState iblockstate = (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.EAST);
         IBlockState iblockstate1 = (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, EnumFacing.WEST);
   ...
   abstract static class Stronghold extends StructurePiece {
      ...
      protected void placeDoor(IWorld worldIn, Random p_74990_2_, MutableBoundingBox p_74990_3_, StrongholdPieces.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_) {
         ...
         case WOOD_DOOR:
            ...
            this.setBlockState(worldIn, (IBlockState)Blocks.OAK_DOOR.getDefaultState().with(BlockDoor.HALF, DoubleBlockHalf.UPPER), p_74990_5_ + 1, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            break;
         case GRATES:
            ...
            this.setBlockState(worldIn, (IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.WEST, Boolean.valueOf(true)), p_74990_5_, p_74990_6_, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.WEST, Boolean.valueOf(true)), p_74990_5_, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.EAST, Boolean.valueOf(true))).with(BlockPane.WEST, Boolean.valueOf(true)), p_74990_5_, p_74990_6_ + 2, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.EAST, Boolean.valueOf(true))).with(BlockPane.WEST, Boolean.valueOf(true)), p_74990_5_ + 1, p_74990_6_ + 2, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.EAST, Boolean.valueOf(true))).with(BlockPane.WEST, Boolean.valueOf(true)), p_74990_5_ + 2, p_74990_6_ + 2, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.EAST, Boolean.valueOf(true)), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.EAST, Boolean.valueOf(true)), p_74990_5_ + 2, p_74990_6_, p_74990_7_, p_74990_3_);
            break;
         case IRON_DOOR:
            this.setBlockState(worldIn, Blocks.STONE_BRICKS.getDefaultState(), p_74990_5_, p_74990_6_, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, Blocks.STONE_BRICKS.getDefaultState(), p_74990_5_, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            ...
            this.setBlockState(worldIn, (IBlockState)Blocks.IRON_DOOR.getDefaultState().with(BlockDoor.HALF, DoubleBlockHalf.UPPER), p_74990_5_ + 1, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)Blocks.STONE_BUTTON.getDefaultState().with(BlockButton.HORIZONTAL_FACING, EnumFacing.NORTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ + 1, p_74990_3_);
            this.setBlockState(worldIn, (IBlockState)Blocks.STONE_BUTTON.getDefaultState().with(BlockButton.HORIZONTAL_FACING, EnumFacing.SOUTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ - 1, p_74990_3_);
         }
