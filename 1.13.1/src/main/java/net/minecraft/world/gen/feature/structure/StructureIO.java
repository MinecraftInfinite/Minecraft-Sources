...
public class StructureIO {
   ...
   private static final Map<String, Class<? extends StructurePiece>> componentNameToClassMap = Maps.<String, Class<? extends StructurePiece>>newHashMap();
   private static final Map<Class<? extends StructurePiece>, String> componentClassToNameMap = Maps.<Class<? extends StructurePiece>, String>newHashMap();
