...
public abstract class StructurePiece {
   ...
   public static IBlockState func_197528_a(IBlockReader p_197528_0_, BlockPos p_197528_1_, IBlockState p_197528_2_) {
      ...
      if (enumfacing != null) {
         return (IBlockState)p_197528_2_.with(BlockHorizontal.HORIZONTAL_FACING, enumfacing.getOpposite());
      } else {
         EnumFacing enumfacing2 = (EnumFacing)p_197528_2_.get(BlockHorizontal.HORIZONTAL_FACING);
         ...
         return (IBlockState)p_197528_2_.with(BlockHorizontal.HORIZONTAL_FACING, enumfacing2);
      }
   }
   ...
   protected boolean createDispenser(IWorld worldIn, MutableBoundingBox sbb, Random rand, int x, int y, int z, EnumFacing facing, ResourceLocation lootTableIn) {
      ...
      if (sbb.isVecInside(blockpos) && worldIn.getBlockState(blockpos).getBlock() != Blocks.DISPENSER) {
         this.setBlockState(worldIn, (IBlockState)Blocks.DISPENSER.getDefaultState().with(BlockDispenser.FACING, facing), x, y, z, sbb);
   ...
   protected void generateDoor(IWorld worldIn, MutableBoundingBox sbb, Random rand, int x, int y, int z, EnumFacing facing, BlockDoor door) {
      this.setBlockState(worldIn, (IBlockState)door.getDefaultState().with(BlockDoor.FACING, facing), x, y, z, sbb);
      this.setBlockState(worldIn, (IBlockState)((IBlockState)door.getDefaultState().with(BlockDoor.FACING, facing)).with(BlockDoor.HALF, DoubleBlockHalf.UPPER), x, y + 1, z, sbb);
   }
