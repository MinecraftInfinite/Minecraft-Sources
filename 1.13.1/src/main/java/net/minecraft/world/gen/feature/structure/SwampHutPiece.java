...
public class SwampHutPiece extends ScatteredStructurePiece {
   ...
   public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
      if (!this.func_202580_a(worldIn, structureBoundingBoxIn, 0)) {
         ...
         IBlockState iblockstate1 = (IBlockState)Blocks.SPRUCE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.EAST);
         IBlockState iblockstate2 = (IBlockState)Blocks.SPRUCE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.WEST);
         IBlockState iblockstate3 = (IBlockState)Blocks.SPRUCE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH);
         ...
         this.setBlockState(worldIn, (IBlockState)iblockstate.with(BlockStairs.SHAPE, StairsShape.OUTER_RIGHT), 0, 4, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate.with(BlockStairs.SHAPE, StairsShape.OUTER_LEFT), 6, 4, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate3.with(BlockStairs.SHAPE, StairsShape.OUTER_LEFT), 0, 4, 8, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)iblockstate3.with(BlockStairs.SHAPE, StairsShape.OUTER_RIGHT), 6, 4, 8, structureBoundingBoxIn);
