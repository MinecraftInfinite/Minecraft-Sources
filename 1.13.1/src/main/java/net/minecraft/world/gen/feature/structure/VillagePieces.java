...
public class VillagePieces {
   ...
   public static List<VillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size) {
      List<VillagePieces.PieceWeight> list = Lists.<VillagePieces.PieceWeight>newArrayList();
   ...
   public static class Church extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate1 = this.getBiomeSpecificBlockState((IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH));
         IBlockState iblockstate2 = this.getBiomeSpecificBlockState((IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.WEST));
         IBlockState iblockstate3 = this.getBiomeSpecificBlockState((IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.EAST));
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 3, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 4, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 4, 3, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 6, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 7, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 4, 6, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 4, 7, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 6, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 7, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 6, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 7, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 3, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 4, 3, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 3, 8, structureBoundingBoxIn);
         ...
         IBlockState iblockstate4 = (IBlockState)Blocks.LADDER.getDefaultState().with(BlockLadder.FACING, EnumFacing.WEST);
   ...
   public static class Field1 extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         for(int i = 1; i <= 7; ++i) {
            ...
            int k = j / 3;
            this.setBlockState(worldIn, (IBlockState)this.cropTypeA.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, k, j))), 1, 1, i, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)this.cropTypeA.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, k, j))), 2, 1, i, structureBoundingBoxIn);
            blockcrops = (BlockCrops)this.cropTypeB.getBlock();
            int l = blockcrops.getMaxAge();
            int i1 = l / 3;
            this.setBlockState(worldIn, (IBlockState)this.cropTypeB.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, i1, l))), 4, 1, i, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)this.cropTypeB.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, i1, l))), 5, 1, i, structureBoundingBoxIn);
            blockcrops = (BlockCrops)this.cropTypeC.getBlock();
            int j1 = blockcrops.getMaxAge();
            int k1 = j1 / 3;
            this.setBlockState(worldIn, (IBlockState)this.cropTypeC.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, k1, j1))), 7, 1, i, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)this.cropTypeC.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, k1, j1))), 8, 1, i, structureBoundingBoxIn);
            blockcrops = (BlockCrops)this.cropTypeD.getBlock();
            int l1 = blockcrops.getMaxAge();
            int i2 = l1 / 3;
            this.setBlockState(worldIn, (IBlockState)this.cropTypeD.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, i2, l1))), 10, 1, i, structureBoundingBoxIn);
            this.setBlockState(worldIn, (IBlockState)this.cropTypeD.with(blockcrops.getAgeProperty(), Integer.valueOf(MathHelper.nextInt(randomIn, i2, l1))), 11, 1, i, structureBoundingBoxIn);
         }
   ...
   public static class Hall extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate1 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH));
         IBlockState iblockstate2 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH));
         IBlockState iblockstate3 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.WEST));
         ...
         IBlockState iblockstate7 = (IBlockState)((IBlockState)iblockstate6.with(BlockFence.NORTH, Boolean.valueOf(true))).with(BlockFence.SOUTH, Boolean.valueOf(true));
         IBlockState iblockstate8 = (IBlockState)((IBlockState)iblockstate6.with(BlockFence.WEST, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true));
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, 1, 6, 2, 1, 9, iblockstate7, iblockstate7, false);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)iblockstate6.with(BlockFence.SOUTH, Boolean.valueOf(true))).with(BlockFence.EAST, Boolean.valueOf(true)), 2, 1, 10, structureBoundingBoxIn);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 8, 1, 6, 8, 1, 9, iblockstate7, iblockstate7, false);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)iblockstate6.with(BlockFence.SOUTH, Boolean.valueOf(true))).with(BlockFence.WEST, Boolean.valueOf(true)), 8, 1, 10, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 2, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 2, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 3, 2, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 5, 2, 0, structureBoundingBoxIn);
         ...
         IBlockState iblockstate11 = (IBlockState)Blocks.STONE_SLAB.getDefaultState().with(BlockSlab.TYPE, SlabType.DOUBLE);
   ...
   public static class House1 extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate1 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH));
         IBlockState iblockstate2 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH));
         IBlockState iblockstate3 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.EAST));
         IBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.OAK_PLANKS.getDefaultState());
         IBlockState iblockstate5 = this.getBiomeSpecificBlockState((IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH));
         IBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 4, 2, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 5, 2, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 6, 2, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 4, 3, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 5, 3, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 6, 3, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 3, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 3, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 2, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 3, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 3, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 2, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 3, 2, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 5, 2, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 6, 2, 5, structureBoundingBoxIn);
   ...
   public static class House2 extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate = Blocks.COBBLESTONE.getDefaultState();
         IBlockState iblockstate1 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH));
         IBlockState iblockstate2 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.WEST));
         IBlockState iblockstate3 = this.getBiomeSpecificBlockState(Blocks.OAK_PLANKS.getDefaultState());
         IBlockState iblockstate4 = this.getBiomeSpecificBlockState((IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH));
         IBlockState iblockstate5 = this.getBiomeSpecificBlockState(Blocks.OAK_LOG.getDefaultState());
         IBlockState iblockstate6 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true))).with(BlockPane.SOUTH, Boolean.valueOf(true)), 9, 2, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.IRON_BARS.getDefaultState().with(BlockPane.NORTH, Boolean.valueOf(true)), 9, 2, 4, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, (IBlockState)Blocks.FURNACE.getDefaultState().with(BlockFurnace.FACING, EnumFacing.SOUTH), 6, 2, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.FURNACE.getDefaultState().with(BlockFurnace.FACING, EnumFacing.SOUTH), 6, 3, 3, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)Blocks.STONE_SLAB.getDefaultState().with(BlockSlab.TYPE, SlabType.DOUBLE), 8, 1, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 2, 6, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 4, 2, 6, structureBoundingBoxIn);
   ...
   public static class House3 extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate2 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.SOUTH));
         IBlockState iblockstate3 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.EAST));
         IBlockState iblockstate4 = this.getBiomeSpecificBlockState((IBlockState)Blocks.OAK_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.WEST));
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 2, 7, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 8, 2, 8, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 2, 2, 7, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 2, 2, 8, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 5, 4, 10, structureBoundingBoxIn);
   ...
   public static class House4Garden extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         IBlockState iblockstate2 = this.getBiomeSpecificBlockState((IBlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, EnumFacing.NORTH));
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.EAST, Boolean.valueOf(true))).with(BlockGlassPane.WEST, Boolean.valueOf(true)), 2, 2, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 4, 2, 2, structureBoundingBoxIn);
            ...
            for(int k = 0; k <= 4; ++k) {
               for(int l = 0; l <= 4; ++l) {
                  ...
                  if (flag || flag1) {
                     ...
                     IBlockState iblockstate5 = (IBlockState)((IBlockState)((IBlockState)((IBlockState)iblockstate4.with(BlockFence.SOUTH, Boolean.valueOf(flag2 && l != 0))).with(BlockFence.NORTH, Boolean.valueOf(flag2 && l != 4))).with(BlockFence.WEST, Boolean.valueOf(flag3 && k != 0))).with(BlockFence.EAST, Boolean.valueOf(flag3 && k != 4));
         ...
         if (this.isRoofAccessible) {
            IBlockState iblockstate6 = (IBlockState)Blocks.LADDER.getDefaultState().with(BlockLadder.FACING, EnumFacing.SOUTH);
   ...
   public static class Start extends VillagePieces.Well {
      ...
      public List<StructurePiece> pendingHouses = Lists.<StructurePiece>newArrayList();
      public List<StructurePiece> pendingRoads = Lists.<StructurePiece>newArrayList();
   ...
   abstract static class Village extends StructurePiece {
      ...
      protected IBlockState getBiomeSpecificBlockState(IBlockState blockstateIn) {
         ...
         if (this.structureType == VillagePieces.Type.SANDSTONE) {
            ...
            if (block == Blocks.OAK_STAIRS) {
               return (IBlockState)Blocks.SANDSTONE_STAIRS.getDefaultState().with(BlockStairs.FACING, blockstateIn.get(BlockStairs.FACING));
            }
            ...
            if (block.isIn(BlockTags.LOGS)) {
               return (IBlockState)Blocks.SPRUCE_LOG.getDefaultState().with(BlockLog.AXIS, blockstateIn.get(BlockLog.AXIS));
            }
            ...
            if (block == Blocks.OAK_STAIRS) {
               return (IBlockState)Blocks.SPRUCE_STAIRS.getDefaultState().with(BlockStairs.FACING, blockstateIn.get(BlockStairs.FACING));
            }
            ...
            if (block.isIn(BlockTags.LOGS)) {
               return (IBlockState)Blocks.ACACIA_LOG.getDefaultState().with(BlockLog.AXIS, blockstateIn.get(BlockLog.AXIS));
            }
            ...
            if (block == Blocks.OAK_STAIRS) {
               return (IBlockState)Blocks.ACACIA_STAIRS.getDefaultState().with(BlockStairs.FACING, blockstateIn.get(BlockStairs.FACING));
            }
      ...
      protected void placeTorch(IWorld p_189926_1_, EnumFacing p_189926_2_, int p_189926_3_, int p_189926_4_, int p_189926_5_, MutableBoundingBox p_189926_6_) {
         if (!this.isZombieInfested) {
            this.setBlockState(p_189926_1_, (IBlockState)Blocks.WALL_TORCH.getDefaultState().with(BlockTorchWall.HORIZONTAL_FACING, p_189926_2_), p_189926_3_, p_189926_4_, p_189926_5_, p_189926_6_);
         }
   ...
   public static class WoodHut extends VillagePieces.Village {
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 0, 2, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, (IBlockState)((IBlockState)Blocks.GLASS_PANE.getDefaultState().with(BlockGlassPane.SOUTH, Boolean.valueOf(true))).with(BlockGlassPane.NORTH, Boolean.valueOf(true)), 3, 2, 2, structureBoundingBoxIn);
         if (this.tablePosition > 0) {
            this.setBlockState(worldIn, (IBlockState)((IBlockState)iblockstate4.with(BlockFence.NORTH, Boolean.valueOf(true))).with(this.tablePosition == 1 ? BlockFence.WEST : BlockFence.EAST, Boolean.valueOf(true)), this.tablePosition, 1, 3, structureBoundingBoxIn);
