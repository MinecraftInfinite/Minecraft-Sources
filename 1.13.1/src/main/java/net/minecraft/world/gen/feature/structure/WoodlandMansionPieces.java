      ...
      protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
         if (function.startsWith("Chest")) {
            ...
            if ("ChestWest".equals(function)) {
               iblockstate = (IBlockState)iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.WEST));
            } else if ("ChestEast".equals(function)) {
               iblockstate = (IBlockState)iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.EAST));
            } else if ("ChestSouth".equals(function)) {
               iblockstate = (IBlockState)iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.SOUTH));
            } else if ("ChestNorth".equals(function)) {
               iblockstate = (IBlockState)iblockstate.with(BlockChest.FACING, rotation.rotate(EnumFacing.NORTH));
            }
