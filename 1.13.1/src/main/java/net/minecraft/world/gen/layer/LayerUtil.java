...
public class LayerUtil {
   ...
   public static <T extends IArea, C extends IContextExtended<T>> ImmutableList<IAreaFactory<T>> buildOverworldProcedure(WorldType worldTypeIn, OverworldGenSettings settings, LongFunction<C> contextFactory) {
      IAreaFactory<T> iareafactory = GenLayerIsland.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(1L));
      iareafactory = GenLayerZoom.FUZZY.<T>apply((IContextExtended)contextFactory.apply(2000L), iareafactory);
      iareafactory = GenLayerAddIsland.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(1L), iareafactory);
      iareafactory = GenLayerZoom.NORMAL.<T>apply((IContextExtended)contextFactory.apply(2001L), iareafactory);
      iareafactory = GenLayerAddIsland.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(2L), iareafactory);
      ...
      iareafactory = GenLayerEdge.CoolWarm.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(2L), iareafactory);
      iareafactory = GenLayerEdge.HeatIce.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(2L), iareafactory);
      iareafactory = GenLayerEdge.Special.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(3L), iareafactory);
      iareafactory = GenLayerZoom.NORMAL.<T>apply((IContextExtended)contextFactory.apply(2002L), iareafactory);
      iareafactory = GenLayerZoom.NORMAL.<T>apply((IContextExtended)contextFactory.apply(2003L), iareafactory);
      iareafactory = GenLayerAddIsland.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(4L), iareafactory);
      iareafactory = GenLayerAddMushroomIsland.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(5L), iareafactory);
      iareafactory = GenLayerDeepOcean.INSTANCE.<T>apply((IContextExtended)contextFactory.apply(4L), iareafactory);
      ...
      IAreaFactory<T> lvt_8_1_ = (new GenLayerBiome(worldTypeIn, settings)).apply((IContextExtended)contextFactory.apply(200L), iareafactory);
      ...
      return ImmutableList.<IAreaFactory<T>>of(lvt_8_1_, iareafactory5, lvt_8_1_);
   }
