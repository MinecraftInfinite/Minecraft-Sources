...
public class EndSpikes extends BasePlacement<NoPlacementConfig> {
   private static final LoadingCache<Long, EndCrystalTowerFeature.EndSpike[]> CACHE = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).<Long, EndCrystalTowerFeature.EndSpike[]>build(new EndSpikes.CacheLoader());
