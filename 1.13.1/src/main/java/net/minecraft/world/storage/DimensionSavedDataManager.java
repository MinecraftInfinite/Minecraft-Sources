...
public class DimensionSavedDataManager {
   ...
   private Map<String, WorldSavedData> field_212778_c = Maps.<String, WorldSavedData>newHashMap();
   private final Object2IntMap<String> field_212779_d = new Object2IntOpenHashMap<String>();
   @Nullable
   ...
   public <T extends WorldSavedData> T getOrLoadData(Function<String, T> factory, String name) {
      ...
      if (worldsaveddata == null && this.field_212780_e != null) {
         try {
            File file1 = this.field_212780_e.getDataFile(this.field_212777_b, name);
            if (file1 != null && file1.exists()) {
               worldsaveddata = (WorldSavedData)factory.apply(name);
               worldsaveddata.read(func_212774_a(this.field_212780_e, this.field_212777_b, name, 1628).getCompound("data"));
   ...
   public void loadIdCounts() {
      try {
         ...
         File file1 = this.field_212780_e.getDataFile(this.field_212777_b, "idcounts");
         if (file1 != null && file1.exists()) {
   ...
   public static NBTTagCompound func_212774_a(ISaveHandler p_212774_0_, DimensionType p_212774_1_, String p_212774_2_, int p_212774_3_) throws IOException {
      File file1 = p_212774_0_.getDataFile(p_212774_1_, p_212774_2_);
   ...
   private void saveData(WorldSavedData data) {
      if (this.field_212780_e != null) {
         try {
            File file1 = this.field_212780_e.getDataFile(this.field_212777_b, data.getName());
            if (file1 != null) {
               NBTTagCompound nbttagcompound = new NBTTagCompound();
               nbttagcompound.put("data", data.write(new NBTTagCompound()));
               nbttagcompound.putInt("DataVersion", 1628);
