...
public class WorldSummary implements Comparable<WorldSummary> {
   ...
   public ITextComponent func_200538_i() {
      return (ITextComponent)(StringUtils.isNullOrEmpty(this.versionName) ? new TextComponentTranslation("selectWorld.versionUnknown", new Object[0]) : new TextComponentString(this.versionName));
   }
