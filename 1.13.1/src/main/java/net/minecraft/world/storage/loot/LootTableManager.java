...
public class LootTableManager implements IResourceManagerReloadListener {
   ...
   private final Map<ResourceLocation, LootTable> registeredLootTables = Maps.<ResourceLocation, LootTable>newHashMap();
   ...
   public void onResourceManagerReload(IResourceManager resourceManager) {
      ...
      for(ResourceLocation resourcelocation : resourceManager.getAllResourceLocations("loot_tables", (p_195434_0_) -> {
         ...
         try (IResource iresource = resourceManager.getResource(resourcelocation)) {
            LootTable loottable = (LootTable)JsonUtils.fromJson(GSON_INSTANCE, IOUtils.toString(iresource.getInputStream(), StandardCharsets.UTF_8), LootTable.class);
            if (loottable != null) {
