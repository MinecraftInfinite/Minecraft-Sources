...
public class DedicatedServer extends MinecraftServer implements IServer {
   ...
   public String func_184113_aK() {
      String s = "";
      if(this.field_71340_o.func_187239_a("resource-pack-hash") && !this.field_71340_o.func_187239_a("resource-pack-sha1")) {
         field_155771_h.warn("ressource-pack-hash is depricated. Please use ressource-pack-sha1 instead.");
         s = this.field_71340_o.func_73671_a("resource-pack-hash", "");
         this.field_71340_o.func_73671_a("resource-pack-sha1", s);
         this.field_71340_o.func_187238_b("resource-pack-hash");
      }

      if(this.field_71340_o.func_187239_a("resource-pack-hash") && this.field_71340_o.func_187239_a("resource-pack-sha1")) {
         field_155771_h.warn("ressource-pack-hash is depricated and found along side resource-pack-sha1. resource-pack-hash will be ignored.");
      }

      s = this.field_71340_o.func_73671_a("resource-pack-sha1", "");
      if(!s.equals("") && !s.matches("^[a-f0-9]{40}$")) {
         field_155771_h.warn("Invalid sha1 for ressource-pack-sha1");
      }

      if(!this.field_71340_o.func_73671_a("resource-pack", "").equals("") && s.equals("")) {
